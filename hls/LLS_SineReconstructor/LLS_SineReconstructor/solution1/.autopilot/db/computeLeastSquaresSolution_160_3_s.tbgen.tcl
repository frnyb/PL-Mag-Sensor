set moduleName computeLeastSquaresSolution_160_3_s
set isTopModule 0
...
set C_modelName {computeLeastSquaresSolution<160, 3>}
set C_modelType { void 0 }
set C_modelArgList {
	{ A int 64 regular {array 480 { 1 3 } 1 1 }  }
	{ b int 55 regular {array 160 { 1 3 } 1 1 }  }
	{ x int 64 regular {array 3 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ x_address0 sc_out sc_lv 2 signal 2 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "113", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_107ns_64s_64_111_1_U683", "Parent" : "0"},
	{"ID" : "114", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64s_64s_107_1_1_U684", "Parent" : "0"},
	{"ID" : "115", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_64s_55ns_107_1_1_U685", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "65862", "Max" : "78011"}
	, {"Name" : "Interval", "Min" : "65862", "Max" : "78011"}
]}
...
set Spec2ImplPortList { 
	...
	x { ap_memory {  { x_address0 mem_address 1 2 }  { x_ce0 mem_ce 1 1 }  { x_we0 mem_we 1 1 }  { x_d0 mem_din 1 64 } } }
