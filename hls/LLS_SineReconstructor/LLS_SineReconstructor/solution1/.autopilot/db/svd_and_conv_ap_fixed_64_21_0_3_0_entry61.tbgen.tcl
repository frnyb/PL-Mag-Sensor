set moduleName svd_and_conv_ap_fixed_64_21_0_3_0_entry61
set isTopModule 0
...
set C_modelName {svd_and_conv<ap_fixed<64, 21, 0, 3, 0> >.entry61}
set C_modelType { void 0 }
set C_modelArgList {
	{ alpha int 64 regular  }
	{ beta int 64 regular  }
	{ gamma int 64 regular  }
	{ alpha_out int 64 regular {fifo 1}  }
	{ alpha_out1 int 64 regular {fifo 1}  }
	{ beta_out int 64 regular {fifo 1}  }
	{ beta_out2 int 64 regular {fifo 1}  }
	{ gamma_out int 64 regular {fifo 1}  }
	{ gamma_out3 int 64 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "alpha", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "alpha_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "alpha_out1", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "beta_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "beta_out2", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "gamma_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} , 
 	{ "Name" : "gamma_out3", "interface" : "fifo", "bitwidth" : 64, "direction" : "WRITEONLY"} ]}
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "alpha_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "alpha_out", "role": "din" }} , 
 	...
 	{ "name": "alpha_out1_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "alpha_out1", "role": "din" }} , 
 	...
 	{ "name": "beta_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "beta_out", "role": "din" }} , 
 	...
 	{ "name": "beta_out2_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "beta_out2", "role": "din" }} , 
 	...
 	{ "name": "gamma_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "gamma_out", "role": "din" }} , 
 	...
 	{ "name": "gamma_out3_din", "direction": "out", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "gamma_out3", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	alpha_out { ap_fifo {  { alpha_out_din fifo_data 1 64 }  { alpha_out_full_n fifo_status 0 1 }  { alpha_out_write fifo_update 1 1 } } }
	alpha_out1 { ap_fifo {  { alpha_out1_din fifo_data 1 64 }  { alpha_out1_full_n fifo_status 0 1 }  { alpha_out1_write fifo_update 1 1 } } }
	beta_out { ap_fifo {  { beta_out_din fifo_data 1 64 }  { beta_out_full_n fifo_status 0 1 }  { beta_out_write fifo_update 1 1 } } }
	beta_out2 { ap_fifo {  { beta_out2_din fifo_data 1 64 }  { beta_out2_full_n fifo_status 0 1 }  { beta_out2_write fifo_update 1 1 } } }
	gamma_out { ap_fifo {  { gamma_out_din fifo_data 1 64 }  { gamma_out_full_n fifo_status 0 1 }  { gamma_out_write fifo_update 1 1 } } }
	gamma_out3 { ap_fifo {  { gamma_out3_din fifo_data 1 64 }  { gamma_out3_full_n fifo_status 0 1 }  { gamma_out3_write fifo_update 1 1 } } }
}
