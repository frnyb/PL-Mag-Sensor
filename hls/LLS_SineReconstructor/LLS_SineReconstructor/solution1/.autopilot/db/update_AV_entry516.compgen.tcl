...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s_out \
    op interface \
    ports { s_out_din { O 60 vector } s_out_full_n { I 1 bit } s_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s_out3 \
    op interface \
    ports { s_out3_din { O 60 vector } s_out3_full_n { I 1 bit } s_out3_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_c_out \
    op interface \
    ports { c_out_din { O 60 vector } c_out_full_n { I 1 bit } c_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_c_out4 \
    op interface \
    ports { c_out4_din { O 60 vector } c_out4_full_n { I 1 bit } c_out4_write { O 1 bit } } \
} "
}
