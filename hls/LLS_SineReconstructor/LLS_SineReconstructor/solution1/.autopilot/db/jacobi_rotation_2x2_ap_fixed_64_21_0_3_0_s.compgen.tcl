...
set id 521
set name LLSSineReconstruction_dsub_64ns_64ns_64_5_no_dsp_1
...
set id 522
set name LLSSineReconstruction_dadd_64ns_64ns_64_5_no_dsp_1
...
set id 525
set name LLSSineReconstruction_dmul_64ns_64ns_64_6_max_dsp_1
...
set id 528
set name LLSSineReconstruction_ddiv_64ns_64ns_64_22_no_dsp_1
...
set id 529
set name LLSSineReconstruction_dcmp_64ns_64ns_1_2_no_dsp_1
...
set id 533
set name LLSSineReconstruction_dsqrt_64ns_64ns_64_30_no_dsp_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s_strm4 \
    op interface \
    ports { s_strm4_din { O 64 vector } s_strm4_full_n { I 1 bit } s_strm4_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_c_strm5 \
    op interface \
    ports { c_strm5_din { O 64 vector } c_strm5_full_n { I 1 bit } c_strm5_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_alpha \
    op interface \
    ports { alpha_dout { I 64 vector } alpha_empty_n { I 1 bit } alpha_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_beta \
    op interface \
    ports { beta_dout { I 64 vector } beta_empty_n { I 1 bit } beta_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_gamma \
    op interface \
    ports { gamma_dout { I 64 vector } gamma_empty_n { I 1 bit } gamma_read { O 1 bit } } \
} "
}
