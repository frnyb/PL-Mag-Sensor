; ModuleID = '/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/hls/LLS_SineReconstructor/LLS_SineReconstructor/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %buffer_in_2_copy = alloca [8 x i32], align 512
  %buffer_in_3_copy = alloca [8 x i32], align 512
  %buffer_in_4_copy = alloca [8 x i32], align 512
  %buffer_in_5_copy = alloca [8 x i32], align 512
  %buffer_in_6_copy = alloca [8 x i32], align 512
  %buffer_in_7_copy = alloca [8 x i32], align 512
  %buffer_in_8_copy = alloca [8 x i32], align 512
  ...
  %3 = bitcast i32* %buffer_in_3 to [8 x i32]*
  %4 = bitcast i32* %buffer_in_4 to [8 x i32]*
  %5 = bitcast i32* %buffer_in_5 to [8 x i32]*
  %6 = bitcast i32* %buffer_in_6 to [8 x i32]*
  %7 = bitcast i32* %buffer_in_7 to [8 x i32]*
  %8 = bitcast i32* %buffer_in_8 to [8 x i32]*
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a8i32([8 x i32]* align 512 %13, [8 x i32]* %12)
  call fastcc void @onebyonecpy_hls.p0a8i32([8 x i32]* align 512 %15, [8 x i32]* %14)
  call fastcc void @onebyonecpy_hls.p0a8i32([8 x i32]* align 512 %17, [8 x i32]* %16)
  call fastcc void @onebyonecpy_hls.p0a8i32([8 x i32]* align 512 %19, [8 x i32]* %18)
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %dst.addr.gep1 = getelementptr [8 x i32], [8 x i32]* %0, i64 0, i64 %for.loop.idx3
  %5 = bitcast i32* %dst.addr.gep1 to i8*
  %src.addr.gep2 = getelementptr [8 x i32], [8 x i32]* %1, i64 0, i64 %for.loop.idx3
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a8i32([8 x i32]* %12, [8 x i32]* align 512 %13)
  call fastcc void @onebyonecpy_hls.p0a8i32([8 x i32]* %14, [8 x i32]* align 512 %15)
  call fastcc void @onebyonecpy_hls.p0a8i32([8 x i32]* %16, [8 x i32]* align 512 %17)
  call fastcc void @onebyonecpy_hls.p0a8i32([8 x i32]* %18, [8 x i32]* align 512 %19)
