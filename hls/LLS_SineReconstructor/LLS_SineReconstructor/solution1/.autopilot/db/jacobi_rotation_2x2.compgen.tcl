...
set id 192
set name LLSSineReconstruction_dadddsub_64ns_64ns_64_5_no_dsp_1
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_alpha \
    op interface \
    ports { alpha_dout { I 60 vector } alpha_empty_n { I 1 bit } alpha_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_beta \
    op interface \
    ports { beta_dout { I 60 vector } beta_empty_n { I 1 bit } beta_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_gamma \
    op interface \
    ports { gamma_dout { I 60 vector } gamma_empty_n { I 1 bit } gamma_read { O 1 bit } } \
} "
}
