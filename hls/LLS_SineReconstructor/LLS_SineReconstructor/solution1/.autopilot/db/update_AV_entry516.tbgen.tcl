set moduleName update_AV_entry516
set isTopModule 0
...
set C_modelName {update_AV.entry516}
...
set C_modelArgList {
	...
	{ s_out int 60 regular {fifo 1}  }
	{ s_out3 int 60 regular {fifo 1}  }
	{ c_out int 60 regular {fifo 1}  }
	{ c_out4 int 60 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "col_i", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "s_out", "interface" : "fifo", "bitwidth" : 60, "direction" : "WRITEONLY"} , 
 	{ "Name" : "s_out3", "interface" : "fifo", "bitwidth" : 60, "direction" : "WRITEONLY"} , 
 	{ "Name" : "c_out", "interface" : "fifo", "bitwidth" : 60, "direction" : "WRITEONLY"} , 
 	{ "Name" : "c_out4", "interface" : "fifo", "bitwidth" : 60, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ s sc_in sc_lv 60 signal 2 } 
	{ c sc_in sc_lv 60 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "s_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "s_out", "role": "din" }} , 
 	...
 	{ "name": "s_out3_din", "direction": "out", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "s_out3", "role": "din" }} , 
 	...
 	{ "name": "c_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "c_out", "role": "din" }} , 
 	...
 	{ "name": "c_out4_din", "direction": "out", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "c_out4", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	s { ap_none {  { s in_data 0 60 } } }
	c { ap_none {  { c in_data 0 60 } } }
	...
	s_out { ap_fifo {  { s_out_din fifo_data 1 60 }  { s_out_full_n fifo_status 0 1 }  { s_out_write fifo_update 1 1 } } }
	s_out3 { ap_fifo {  { s_out3_din fifo_data 1 60 }  { s_out3_full_n fifo_status 0 1 }  { s_out3_write fifo_update 1 1 } } }
	c_out { ap_fifo {  { c_out_din fifo_data 1 60 }  { c_out_full_n fifo_status 0 1 }  { c_out_write fifo_update 1 1 } } }
	c_out4 { ap_fifo {  { c_out4_din fifo_data 1 60 }  { c_out4_full_n fifo_status 0 1 }  { c_out4_write fifo_update 1 1 } } }
}
