...
set id 649
set name LLSSineReconstruction_mul_2ns_2ns_4_1_1
...
set id 651
set name LLSSineReconstruction_sdiv_107ns_64s_64_111_1
...
set id 653
set name LLSSineReconstruction_mac_muladd_8ns_2ns_2ns_9_4_1
...
set out_width 9
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {2 0 +} m {9 0 +} i2 {2 0 +} p {9 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 657
set hasByteEnable 0
set MemName LLSSineReconstruction_gesvj_ap_fixed_64_21_0_3_0_160_3_2_2_s_AUS_accu_V
...
# FIFO definition:
set ID 658
set FifoName LLSSineReconstruction_fifo_w64_d16_S
set InstName alpha_strm_U
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename U_V \
    op interface \
    ports { U_V_address0 { O 15 vector } U_V_ce0 { O 1 bit } U_V_we0 { O 1 bit } U_V_d0 { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename S_V \
    op interface \
    ports { S_V_address0 { O 2 vector } S_V_ce0 { O 1 bit } S_V_we0 { O 1 bit } S_V_d0 { O 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename V_V \
    op interface \
    ports { V_V_address0 { O 4 vector } V_V_ce0 { O 1 bit } V_V_we0 { O 1 bit } V_V_d0 { O 64 vector } } \
} "
} else {
