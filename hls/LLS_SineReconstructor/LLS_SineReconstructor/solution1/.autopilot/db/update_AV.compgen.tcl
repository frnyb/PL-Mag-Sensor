...
# FIFO definition:
set ID 272
set FifoName LLSSineReconstruction_fifo_w2_d2_S_x
...
# FIFO definition:
set ID 276
set FifoName LLSSineReconstruction_fifo_w60_d2_S_x
set InstName s_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s \
    op interface \
    ports { s { I 60 vector } s_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_c \
    op interface \
    ports { c { I 60 vector } c_ap_vld { I 1 bit } } \
} "
}
