...
module LLSSineReconstruction_update_AV_ap_fixed_64_21_0_3_0_160_3_2_80_2_2_entry65 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [63:0] s_out_din;
input   s_out_full_n;
output   s_out_write;
output  [63:0] s_out3_din;
input   s_out3_full_n;
output   s_out3_write;
output  [63:0] c_out_din;
input   c_out_full_n;
output   c_out_write;
output  [63:0] c_out4_din;
input   c_out4_full_n;
output   c_out4_write;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (c_out4_full_n == 1'b0) | (c_out_full_n == 1'b0) | (s_out3_full_n == 1'b0) | (s_out_full_n == 1'b0) | (col_j_out2_full_n == 1'b0) | (col_j_out_full_n == 1'b0) | (col_i_out1_full_n == 1'b0) | (col_i_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (c_out4_full_n == 1'b0) | (c_out_full_n == 1'b0) | (s_out3_full_n == 1'b0) | (s_out_full_n == 1'b0) | (col_j_out2_full_n == 1'b0) | (col_j_out_full_n == 1'b0) | (col_i_out1_full_n == 1'b0) | (col_i_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (c_out4_full_n == 1'b0) | (c_out_full_n == 1'b0) | (s_out3_full_n == 1'b0) | (s_out_full_n == 1'b0) | (col_j_out2_full_n == 1'b0) | (col_j_out_full_n == 1'b0) | (col_i_out1_full_n == 1'b0) | (col_i_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
...
endmodule //LLSSineReconstruction_update_AV_ap_fixed_64_21_0_3_0_160_3_2_80_2_2_entry65
