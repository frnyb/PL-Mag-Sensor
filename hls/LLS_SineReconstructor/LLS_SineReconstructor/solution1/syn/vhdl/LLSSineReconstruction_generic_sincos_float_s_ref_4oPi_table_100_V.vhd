...
entity LLSSineReconstruction_generic_sincos_float_s_ref_4oPi_table_100_V_rom is 
    generic(
             DWIDTH     : integer := 100; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 13
...
architecture rtl of LLSSineReconstruction_generic_sincos_float_s_ref_4oPi_table_100_V_rom is 
...
entity LLSSineReconstruction_generic_sincos_float_s_ref_4oPi_table_100_V is
    generic (
...
architecture arch of LLSSineReconstruction_generic_sincos_float_s_ref_4oPi_table_100_V is
    component LLSSineReconstruction_generic_sincos_float_s_ref_4oPi_table_100_V_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    LLSSineReconstruction_generic_sincos_float_s_ref_4oPi_table_100_V_rom_U :  component LLSSineReconstruction_generic_sincos_float_s_ref_4oPi_table_100_V_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
