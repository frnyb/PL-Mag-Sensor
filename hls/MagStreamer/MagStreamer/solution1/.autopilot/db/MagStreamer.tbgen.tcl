...
set C_modelName {MagStreamer}
set C_modelType { void 0 }
set C_modelArgList {
	{ buffer_in int 32 regular {array 240 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "buffer_in", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "buffer_in","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
...
set portList { 
	...
	{ buffer_in_address0 sc_out sc_lv 8 signal 0 } 
	{ buffer_in_ce0 sc_out sc_logic 1 signal 0 } 
	{ buffer_in_q0 sc_in sc_lv 32 signal 0 } 
	...
	{ n_samples sc_in sc_lv 11 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "buffer_in_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "buffer_in", "role": "address0" }} , 
 	{ "name": "buffer_in_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "buffer_in", "role": "ce0" }} , 
 	{ "name": "buffer_in_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "buffer_in", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	buffer_in { ap_memory {  { buffer_in_address0 mem_address 1 8 }  { buffer_in_ce0 mem_ce 1 1 }  { buffer_in_q0 mem_dout 0 32 } } }
