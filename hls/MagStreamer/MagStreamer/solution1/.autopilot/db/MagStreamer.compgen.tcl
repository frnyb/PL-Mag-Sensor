...
set ID 1
set hasByteEnable 0
set MemName MagStreamer_buffer
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename buffer_in \
    op interface \
    ports { buffer_in_address0 { O 8 vector } buffer_in_ce0 { O 1 bit } buffer_in_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'buffer_in'"
}
}
...
# RegSlice definition:
set ID 7
set RegSliceName MagStreamer_regslice_both
set RegSliceInstName MagStreamer_regslice_both_U
set CoreName ap_simcore_MagStreamer_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
