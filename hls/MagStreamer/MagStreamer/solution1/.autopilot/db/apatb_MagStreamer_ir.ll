; ModuleID = '/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/hls/MagStreamer/MagStreamer/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%struct.ap_int = type { %struct.ap_int_base.6 }
%struct.ap_int_base.6 = type { %struct.ssdm_int.7 }
%struct.ssdm_int.7 = type { i11 }

; Function Attrs: noinline
define void @apatb_MagStreamer_ir(i32* %buffer_in, %"class.hls::stream"* %stream_out, %struct.ap_int* nocapture readonly %n_samples) local_unnamed_addr #0 {
entry:
  %buffer_in_copy = alloca [240 x i32], align 512
  %stream_out_copy = alloca %"class.hls::stream", align 512
  %0 = bitcast i32* %buffer_in to [240 x i32]*
  call fastcc void @copy_in([240 x i32]* %0, [240 x i32]* nonnull align 512 %buffer_in_copy, %"class.hls::stream"* %stream_out, %"class.hls::stream"* nonnull align 512 %stream_out_copy)
  %1 = getelementptr inbounds [240 x i32], [240 x i32]* %buffer_in_copy, i32 0, i32 0
  call void @apatb_MagStreamer_hw(i32* %1, %"class.hls::stream"* %stream_out_copy, %struct.ap_int* %n_samples)
  call fastcc void @copy_out([240 x i32]* %0, [240 x i32]* nonnull align 512 %buffer_in_copy, %"class.hls::stream"* %stream_out, %"class.hls::stream"* nonnull align 512 %stream_out_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in([240 x i32]* readonly, [240 x i32]* noalias align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0a240i32([240 x i32]* align 512 %1, [240 x i32]* %0)
...
; Function Attrs: noinline
define internal fastcc void @copy_out([240 x i32]*, [240 x i32]* noalias readonly align 512, %"class.hls::stream"*, %"class.hls::stream"* noalias align 512) unnamed_addr #6 {
entry:
  call fastcc void @onebyonecpy_hls.p0a240i32([240 x i32]* %0, [240 x i32]* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream"(%"class.hls::stream"* %2, %"class.hls::stream"* align 512 %3)
  ret void
}

declare void @apatb_MagStreamer_hw(i32*, %"class.hls::stream"*, %struct.ap_int*)

define void @MagStreamer_hw_stub_wrapper(i32*, %"class.hls::stream"*, %struct.ap_int*) #7 {
entry:
  %3 = bitcast i32* %0 to [240 x i32]*
  call void @copy_out([240 x i32]* null, [240 x i32]* %3, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  %4 = bitcast [240 x i32]* %3 to i32*
  call void @MagStreamer_hw_stub(i32* %4, %"class.hls::stream"* %1, %struct.ap_int* %2)
  call void @copy_in([240 x i32]* null, [240 x i32]* %3, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @MagStreamer_hw_stub(i32*, %"class.hls::stream"*, %struct.ap_int*)
