...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("buffer_in_address0", 8, hls_out, 0, "ap_memory", "mem_address", 1),
	Port_Property("buffer_in_ce0", 1, hls_out, 0, "ap_memory", "mem_ce", 1),
	Port_Property("buffer_in_q0", 32, hls_in, 0, "ap_memory", "mem_dout", 1),
	...
	Port_Property("n_samples", 11, hls_in, 5, "ap_none", "in_data", 1),
};
const char* HLS_Design_Meta::dut_name = "MagStreamer";
