...
void loadBuffer(uint32_t buffer_in[20*12], uint32_t buffer[20*12], ap_int<11> n_samples);

void streamData(uint32_t buffer[20*12], hls::stream<sdata_t,0> *stream_out, ap_int<11> n_samples);

__attribute__((sdx_kernel("MagStreamer", 0))) void MagStreamer(uint32_t buffer_in[20*12], hls::stream<sdata_t,0> *stream_out, ap_int<11> n_samples) {_ssdm_SpecArrayDimSize(buffer_in, 240);
#pragma HLS TOP name=MagStreamer
# 16 "../src/mag_streamer.cpp"
...
void loadBuffer(uint32_t buffer_in[20*12], uint32_t buffer[20*12], ap_int<11> n_samples) {
 ...
 load_loop: for (int i = 0; i < 20*12; i++) {
...
void streamData(uint32_t buffer[20*12], hls::stream<sdata_t,0> *stream_out, ap_int<11> n_samples) {
 ...
 stream_loop: for (int i = 0; i < 20*12; i++) {

  sdata_t dout;
  dout.data = buffer[i];
  dout.keep = -1;
  dout.last = (ap_uint<1>)(i == 20*12 -1);
