...
set C_modelName {SetNextAxis}
set C_modelType { void 0 }
set C_modelArgList {
	{ next_axis_in int 2 regular {axi_slave 0}  }
	{ next_axis_out int 2 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "next_axis_in", "interface" : "axi_slave", "bundle":"CPU","type":"ap_none","bitwidth" : 2, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "next_axis_in","cData": "int2","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "next_axis_out", "interface" : "wire", "bitwidth" : 2, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "next_axis_out","cData": "int2","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} ]}
# RTL Port declarations: 
set portNum 21
set portList { 
	{ next_axis_out sc_out sc_lv 2 signal 1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_CPU_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CPU", "role": "AWADDR" },"address":[{"name":"SetNextAxis","role":"start","value":"0","valid_bit":"0"},{"name":"SetNextAxis","role":"continue","value":"0","valid_bit":"4"},{"name":"SetNextAxis","role":"auto_start","value":"0","valid_bit":"7"},{"name":"next_axis_in","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_CPU_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CPU", "role": "ARADDR" },"address":[{"name":"SetNextAxis","role":"start","value":"0","valid_bit":"0"},{"name":"SetNextAxis","role":"done","value":"0","valid_bit":"1"},{"name":"SetNextAxis","role":"idle","value":"0","valid_bit":"2"},{"name":"SetNextAxis","role":"ready","value":"0","valid_bit":"3"},{"name":"SetNextAxis","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "CPU", "role": "interrupt" } }, 
 	{ "name": "next_axis_out", "direction": "out", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "next_axis_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "next_axis_in", "Type" : "None", "Direction" : "I"},
			{"Name" : "next_axis_out", "Type" : "None", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.CPU_s_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	SetNextAxis {
		next_axis_in {Type I LastRead 0 FirstWrite -1}
		next_axis_out {Type O LastRead -1 FirstWrite 0}}}
...
set Spec2ImplPortList { 
	next_axis_out { ap_none {  { next_axis_out out_data 1 2 } } }
}
