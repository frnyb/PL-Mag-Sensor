; ModuleID = '/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/hls/SetNextAxis/SetNextAxis/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_SetNextAxis_ir(%struct.ap_uint* nocapture readonly %next_axis_in, %struct.ap_uint* %next_axis_out) local_unnamed_addr #0 {
entry:
  %next_axis_out_copy1 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %next_axis_out, %struct.ap_uint* nonnull align 512 %next_axis_out_copy1)
  call void @apatb_SetNextAxis_hw(%struct.ap_uint* %next_axis_in, %struct.ap_uint* %next_axis_out_copy1)
  call fastcc void @copy_out(%struct.ap_uint* %next_axis_out, %struct.ap_uint* nonnull align 512 %next_axis_out_copy1)
  ret void
}
...
declare void @apatb_SetNextAxis_hw(%struct.ap_uint*, %struct.ap_uint*)

define void @SetNextAxis_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %1)
  call void @SetNextAxis_hw_stub(%struct.ap_uint* %0, %struct.ap_uint* %1)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %1)
  ret void
}

declare void @SetNextAxis_hw_stub(%struct.ap_uint*, %struct.ap_uint*)
