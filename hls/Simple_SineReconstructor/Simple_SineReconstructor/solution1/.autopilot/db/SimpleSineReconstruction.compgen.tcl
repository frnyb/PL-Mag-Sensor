...
set ID 1651
set hasByteEnable 0
set MemName SimpleSineReconstruction_sine_data_sliding_window_buffer_amplitudes_V_0
...
set ID 1652
set hasByteEnable 0
set MemName SimpleSineReconstruction_sine_data_sliding_window_buffer_max_val_times_0
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 21
set AddrRange 10
...
set ID 1653
set hasByteEnable 0
set MemName SimpleSineReconstruction_sample_sliding_window_buffer_samples_sample_V_0_0
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 12
set AddrRange 20
...
set ID 1654
set hasByteEnable 0
set MemName SimpleSineReconstruction_sample_sliding_window_buffer_samples_timestamp_V_0_0
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 20
set AddrRange 20
...
set ID 1655
set hasByteEnable 0
set MemName SimpleSineReconstruction_sample_sliding_window_buffer_count_s
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 6
set AddrRange 20
...
set ID 1656
set hasByteEnable 0
set MemName SimpleSineReconstruction_phases_i
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 12
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 1670 \
    name sines_buffer_out \
    reset_level 1 \
    sync_rst true \
    dir IO \
    corename sines_buffer_out \
    op interface \
    ports { sines_buffer_out_address0 { O 5 vector } sines_buffer_out_ce0 { O 1 bit } sines_buffer_out_we0 { O 1 bit } sines_buffer_out_d0 { O 32 vector } sines_buffer_out_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'sines_buffer_out'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { samples_buffer_out_address0 { O 13 vector } samples_buffer_out_ce0 { O 1 bit } samples_buffer_out_we0 { O 1 bit } samples_buffer_out_d0 { O 32 vector } samples_buffer_out_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { n_samples { I 8 vector } n_samples_ap_vld { I 1 bit } } \
} "
}
