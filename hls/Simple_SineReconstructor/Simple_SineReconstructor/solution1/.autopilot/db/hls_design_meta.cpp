...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("n_samples", 8, hls_in, 12, "ap_vld", "in_data", 1),
	Port_Property("n_samples_ap_vld", 1, hls_in, 12, "ap_vld", "in_vld", 1),
	Port_Property("sines_buffer_out_address0", 5, hls_out, 13, "ap_memory", "mem_address", 1),
	Port_Property("sines_buffer_out_ce0", 1, hls_out, 13, "ap_memory", "mem_ce", 1),
	Port_Property("sines_buffer_out_we0", 1, hls_out, 13, "ap_memory", "mem_we", 1),
	Port_Property("sines_buffer_out_d0", 32, hls_out, 13, "ap_memory", "mem_din", 1),
	Port_Property("sines_buffer_out_q0", 32, hls_in, 13, "ap_memory", "mem_dout", 1),
	Port_Property("samples_buffer_out_address0", 13, hls_out, 14, "ap_memory", "mem_address", 1),
	Port_Property("samples_buffer_out_ce0", 1, hls_out, 14, "ap_memory", "mem_ce", 1),
	Port_Property("samples_buffer_out_we0", 1, hls_out, 14, "ap_memory", "mem_we", 1),
	Port_Property("samples_buffer_out_d0", 32, hls_out, 14, "ap_memory", "mem_din", 1),
	Port_Property("samples_buffer_out_q0", 32, hls_in, 14, "ap_memory", "mem_dout", 1),
};
const char* HLS_Design_Meta::dut_name = "SimpleSineReconstruction";
