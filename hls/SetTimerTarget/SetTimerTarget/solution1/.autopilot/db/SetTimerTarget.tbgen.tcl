...
set C_modelName {SetTimerTarget}
set C_modelType { void 0 }
set C_modelArgList {
	{ timer_target_in int 32 regular {axi_slave 0}  }
	{ timer_target_out int 32 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "timer_target_in", "interface" : "axi_slave", "bundle":"CPU","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "timer_target_in","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "timer_target_out", "interface" : "wire", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "timer_target_out","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} ]}
# RTL Port declarations: 
set portNum 21
set portList { 
	{ timer_target_out sc_out sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_CPU_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CPU", "role": "AWADDR" },"address":[{"name":"SetTimerTarget","role":"start","value":"0","valid_bit":"0"},{"name":"SetTimerTarget","role":"continue","value":"0","valid_bit":"4"},{"name":"SetTimerTarget","role":"auto_start","value":"0","valid_bit":"7"},{"name":"timer_target_in","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_CPU_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CPU", "role": "ARADDR" },"address":[{"name":"SetTimerTarget","role":"start","value":"0","valid_bit":"0"},{"name":"SetTimerTarget","role":"done","value":"0","valid_bit":"1"},{"name":"SetTimerTarget","role":"idle","value":"0","valid_bit":"2"},{"name":"SetTimerTarget","role":"ready","value":"0","valid_bit":"3"},{"name":"SetTimerTarget","role":"auto_start","value":"0","valid_bit":"7"}] },
	...
	{ "name": "interrupt", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "CPU", "role": "interrupt" } }, 
 	{ "name": "timer_target_out", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "timer_target_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "timer_target_in", "Type" : "None", "Direction" : "I"},
			{"Name" : "timer_target_out", "Type" : "None", "Direction" : "O"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.CPU_s_axi_U", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	SetTimerTarget {
		timer_target_in {Type I LastRead 0 FirstWrite -1}
		timer_target_out {Type O LastRead -1 FirstWrite 0}}}
...
set Spec2ImplPortList { 
	timer_target_out { ap_none {  { timer_target_out out_data 1 32 } } }
}
