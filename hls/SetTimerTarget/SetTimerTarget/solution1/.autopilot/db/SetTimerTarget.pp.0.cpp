...
# 2 "SetTimerTarget.cpp" 2

__attribute__((sdx_kernel("SetTimerTarget", 0))) void SetTimerTarget(uint32_t timer_target_in, uint32_t *timer_target_out)
{
#pragma HLS TOP name=SetTimerTarget
# 4 "SetTimerTarget.cpp"
