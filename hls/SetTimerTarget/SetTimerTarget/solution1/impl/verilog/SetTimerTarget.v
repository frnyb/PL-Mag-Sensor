...
(* CORE_GENERATION_INFO="SetTimerTarget_SetTimerTarget,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.000000,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=74,HLS_SYN_LUT=104,HLS_VERSION=2020_2}" *)
...
wire    ap_idle;
wire    ap_ready;
wire   [31:0] timer_target_in;
 reg    ap_rst_n_inv;
wire    ap_ce_reg;

SetTimerTarget_CPU_s_axi #(
...
CPU_s_axi_U(
    ...
    .ARESET(ap_rst_n_inv),
    .ACLK_EN(1'b1),
    .timer_target_in(timer_target_in),
    .ap_start(ap_start),
    .interrupt(interrupt),
    .ap_ready(ap_ready),
    .ap_done(ap_done),
...
assign timer_target_out = timer_target_in;

endmodule //SetTimerTarget
