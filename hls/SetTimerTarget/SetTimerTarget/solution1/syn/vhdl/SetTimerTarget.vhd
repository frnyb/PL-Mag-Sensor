...
entity SetTimerTarget is
generic (
    C_S_AXI_CPU_ADDR_WIDTH : INTEGER := 5;
    C_S_AXI_CPU_DATA_WIDTH : INTEGER := 32 );
port (
    timer_target_out : OUT STD_LOGIC_VECTOR (31 downto 0);
...
architecture behav of SetTimerTarget is 
    ...
    signal timer_target_in : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_rst_n_inv : STD_LOGIC;
    signal ap_ce_reg : STD_LOGIC;

    component SetTimerTarget_CPU_s_axi IS
    generic (
...
begin
    CPU_s_axi_U : component SetTimerTarget_CPU_s_axi
    generic map (
