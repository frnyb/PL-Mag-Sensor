...
__attribute__((sdx_kernel("ControlGain", 0))) void ControlGain(uint8_t gain_ref_in, uint8_t *gain_ref_out, uint8_t gain_in, uint8_t *gain_out)
{
#pragma HLS TOP name=ControlGain
# 4 "ControlGain.cpp"
