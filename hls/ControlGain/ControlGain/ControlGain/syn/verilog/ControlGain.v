...
wire    ap_idle;
wire    ap_ready;
wire   [7:0] gain_ref_in;
reg    gain_out_ap_vld;
 reg    ap_rst_n_inv;
wire    ap_ce_reg;

ControlGain_CPU_s_axi #(
...
always @ (*) begin
    if ((ap_start == 1'b1)) begin
        gain_out_ap_vld = 1'b1;
    end else begin
        gain_out_ap_vld = 1'b0;
    end
end
...
assign gain_ref_out = gain_ref_in;

endmodule //ControlGain
