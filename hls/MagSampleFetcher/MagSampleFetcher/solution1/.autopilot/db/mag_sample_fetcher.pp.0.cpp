...
# 5 "mag_sample_fetcher.cpp" 2
# 14 "mag_sample_fetcher.cpp"
void loadBuffer(uint32_t buffer_in[20], uint32_t buffer[20], int n_samples);

void writeData(uint32_t buffer[20], uint32_t buffer_out[12*20*32], int channel, int curr_n_samples, int n_samples);

__attribute__((sdx_kernel("MagSampleFetcher", 0))) void MagSampleFetcher(uint32_t buffer_in_0[20], uint32_t buffer_in_1[20], uint32_t buffer_in_2[20],
  uint32_t buffer_in_3[20], uint32_t buffer_in_4[20], uint32_t buffer_in_5[20],
  uint32_t buffer_in_6[20], uint32_t buffer_in_7[20], uint32_t buffer_in_8[20],
  uint32_t buffer_in_9[20], uint32_t buffer_in_10[20], uint32_t buffer_in_11[20],
  uint32_t buffer_out[12*20*32], uint8_t n_periods, volatile bool *bfr_irq, volatile ap_uint<6> *n_samples, uint32_t *n_samples_out) {_ssdm_SpecArrayDimSize(buffer_in_0, 20);_ssdm_SpecArrayDimSize(buffer_in_1, 20);_ssdm_SpecArrayDimSize(buffer_in_2, 20);_ssdm_SpecArrayDimSize(buffer_in_3, 20);_ssdm_SpecArrayDimSize(buffer_in_4, 20);_ssdm_SpecArrayDimSize(buffer_in_5, 20);_ssdm_SpecArrayDimSize(buffer_in_6, 20);_ssdm_SpecArrayDimSize(buffer_in_7, 20);_ssdm_SpecArrayDimSize(buffer_in_8, 20);_ssdm_SpecArrayDimSize(buffer_in_9, 20);_ssdm_SpecArrayDimSize(buffer_in_10, 20);_ssdm_SpecArrayDimSize(buffer_in_11, 20);_ssdm_SpecArrayDimSize(buffer_out, 7680);
#pragma HLS TOP name=MagSampleFetcher
# 22 "mag_sample_fetcher.cpp"
...
#pragma HLS INTERFACE ap_vld port=n_samples
 ...
 uint32_t buffer_0[20];
 uint32_t buffer_1[20];
 uint32_t buffer_2[20];
 uint32_t buffer_3[20];
 uint32_t buffer_4[20];
 uint32_t buffer_5[20];
 uint32_t buffer_6[20];
 uint32_t buffer_7[20];
 uint32_t buffer_8[20];
 uint32_t buffer_9[20];
 uint32_t buffer_10[20];
 uint32_t buffer_11[20];

 int n_samples_total = 0;

 VITIS_LOOP_61_1: for (int i = 0; i < n_periods; i++) {


  VITIS_LOOP_64_2: while(!(*bfr_irq));
...
void writeData(uint32_t buffer[20], uint32_t buffer_out[12*20*32], int channel, int curr_n_samples, int n_samples) {
 ...
 int start_idx = curr_n_samples*12 + channel;

 VITIS_LOOP_116_1: for (int i = 0; i < n_samples; i++) {

  int idx_out = start_idx + i*12;
