...
set id 9
set name MagSampleFetcher_mul_8ns_6ns_14_1_1
...
set ID 11
set hasByteEnable 0
set MemName MagSampleFetcher_buffer_0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 12 \
			corename MagSampleFetcher_axi_axilite \
			name MagSampleFetcher_axi_s_axi \
			ports {$port_axi} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler MagSampleFetcher_axi_s_axi
}
