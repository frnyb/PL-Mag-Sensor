...
set C_modelArgMapList {[ 
	{ "Name" : "buffer_out", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "curr_n_samples", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ buffer_out_address0 sc_out sc_lv 13 signal 0 } 
	...
	{ curr_n_samples sc_in sc_lv 11 signal 3 } 
	{ n_samples sc_in sc_lv 6 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "curr_n_samples", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "curr_n_samples", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	curr_n_samples { ap_none {  { curr_n_samples in_data 0 11 } } }
