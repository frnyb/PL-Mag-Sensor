...
extern "C" void ApplyGain(__cosim_s1__, float, volatile void *);
extern "C" void apatb_ApplyGain_hw(__cosim_s1__ __xlx_apatb_param_gain_step, float __xlx_apatb_param_signal_in, volatile void * __xlx_apatb_param_signal_out) {
  // DUT call
  ApplyGain(__xlx_apatb_param_gain_step, __xlx_apatb_param_signal_in, __xlx_apatb_param_signal_out);
}
