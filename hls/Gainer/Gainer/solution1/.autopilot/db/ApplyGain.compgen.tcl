...
set id 1
set name ApplyGain_fadd_32ns_32ns_32_5_full_dsp_1
...
set id 3
set name ApplyGain_fmul_32ns_32ns_32_4_max_dsp_1
...
set id 4
set name ApplyGain_sitofp_32s_32_4_no_dsp_1
...
set id 5
set name ApplyGain_fpext_32ns_64_2_no_dsp_1
...
set id 6
set name ApplyGain_dmul_64ns_64ns_64_6_max_dsp_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_gain_step \
    op interface \
    ports { gain_step { I 6 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_signal_in \
    op interface \
    ports { signal_in { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_signal_out \
    op interface \
    ports { signal_out { O 12 vector } signal_out_ap_vld { O 1 bit } } \
} "
}
