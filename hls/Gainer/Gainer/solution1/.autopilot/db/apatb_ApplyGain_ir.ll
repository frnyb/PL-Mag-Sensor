; ModuleID = '/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/hls/Gainer/Gainer/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_ApplyGain_ir(%struct.ap_int* nocapture readonly %gain_step, float %signal_in, %struct.ap_int.0* %signal_out) local_unnamed_addr #0 {
entry:
  %signal_out_copy1 = alloca %struct.ap_int.0, align 512
  call fastcc void @copy_in(%struct.ap_int.0* %signal_out, %struct.ap_int.0* nonnull align 512 %signal_out_copy1)
  call void @apatb_ApplyGain_hw(%struct.ap_int* %gain_step, float %signal_in, %struct.ap_int.0* %signal_out_copy1)
  call fastcc void @copy_out(%struct.ap_int.0* %signal_out, %struct.ap_int.0* nonnull align 512 %signal_out_copy1)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%struct.ap_int.0* noalias, %struct.ap_int.0* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @onebyonecpy_hls.p0struct.ap_int.0(%struct.ap_int.0* align 512 %1, %struct.ap_int.0* %0)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @onebyonecpy_hls.p0struct.ap_int.0(%struct.ap_int.0* noalias align 512, %struct.ap_int.0* noalias) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  %5 = bitcast %struct.ap_int.0* %1 to i8*
  %6 = call i1 @fpga_fifo_exist_2(i8* %5)
  br i1 %6, label %7, label %8

; <label>:7:                                      ; preds = %copy
  call fastcc void @streamcpy_hls.p0struct.ap_int.0(%struct.ap_int.0* nonnull align 512 %0, %struct.ap_int.0* nonnull %1)
  br label %ret

; <label>:8:                                      ; preds = %copy
  %.0 = getelementptr %struct.ap_int.0, %struct.ap_int.0* %1, i32 0, i32 0
  %.01 = getelementptr %struct.ap_int.0, %struct.ap_int.0* %0, i32 0, i32 0
...
; <label>:11:                                     ; preds = %8
  %.0.02 = getelementptr %struct.ap_int.0, %struct.ap_int.0* %1, i32 0, i32 0, i32 0
  %.01.03 = getelementptr %struct.ap_int.0, %struct.ap_int.0* %0, i32 0, i32 0, i32 0
...
; <label>:14:                                     ; preds = %11
  %15 = bitcast %struct.ap_int.0* %0 to i8*
...
define internal fastcc void @streamcpy_hls.p0struct.ap_int.0(%struct.ap_int.0* noalias nocapture align 512, %struct.ap_int.0* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%struct.ap_int.0* noalias, %struct.ap_int.0* noalias align 512) unnamed_addr #5 {
entry:
  call fastcc void @onebyonecpy_hls.p0struct.ap_int.0(%struct.ap_int.0* %0, %struct.ap_int.0* align 512 %1)
  ret void
}

declare void @apatb_ApplyGain_hw(%struct.ap_int*, float, %struct.ap_int.0*)

define void @ApplyGain_hw_stub_wrapper(%struct.ap_int*, float, %struct.ap_int.0*) #6 {
entry:
  call void @copy_out(%struct.ap_int.0* null, %struct.ap_int.0* %2)
  call void @ApplyGain_hw_stub(%struct.ap_int* %0, float %1, %struct.ap_int.0* %2)
  call void @copy_in(%struct.ap_int.0* null, %struct.ap_int.0* %2)
  ret void
}

declare void @ApplyGain_hw_stub(%struct.ap_int*, float, %struct.ap_int.0*)
