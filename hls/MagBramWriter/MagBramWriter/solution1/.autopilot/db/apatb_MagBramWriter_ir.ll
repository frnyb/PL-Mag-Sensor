; ModuleID = '/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/hls/MagBramWriter/MagBramWriter/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline
define void @apatb_MagBramWriter_ir(i32* %buffer_in_0, i32* %buffer_in_1, i32* %buffer_in_2, i32* %buffer_in_3, i32* %buffer_in_4, i32* %buffer_in_5, i32* %buffer_in_6, i32* %buffer_in_7, i32* %buffer_in_8, i32* %buffer_in_9, i32* %buffer_in_10, i32* %buffer_in_11, i32* %buffer_out) local_unnamed_addr #0 {
entry:
  ...
  %buffer_out_copy = alloca [240 x i32], align 512
  ...
  %25 = getelementptr inbounds [240 x i32], [240 x i32]* %buffer_out_copy, i32 0, i32 0
  call void @apatb_MagBramWriter_hw(i32* %13, i32* %14, i32* %15, i32* %16, i32* %17, i32* %18, i32* %19, i32* %20, i32* %21, i32* %22, i32* %23, i32* %24, i32* %25)
  call fastcc void @copy_out([20 x i32]* %0, [20 x i32]* nonnull align 512 %buffer_in_0_copy, [20 x i32]* %1, [20 x i32]* nonnull align 512 %buffer_in_1_copy, [20 x i32]* %2, [20 x i32]* nonnull align 512 %buffer_in_2_copy, [20 x i32]* %3, [20 x i32]* nonnull align 512 %buffer_in_3_copy, [20 x i32]* %4, [20 x i32]* nonnull align 512 %buffer_in_4_copy, [20 x i32]* %5, [20 x i32]* nonnull align 512 %buffer_in_5_copy, [20 x i32]* %6, [20 x i32]* nonnull align 512 %buffer_in_6_copy, [20 x i32]* %7, [20 x i32]* nonnull align 512 %buffer_in_7_copy, [20 x i32]* %8, [20 x i32]* nonnull align 512 %buffer_in_8_copy, [20 x i32]* %9, [20 x i32]* nonnull align 512 %buffer_in_9_copy, [20 x i32]* %10, [20 x i32]* nonnull align 512 %buffer_in_10_copy, [20 x i32]* %11, [20 x i32]* nonnull align 512 %buffer_in_11_copy, [240 x i32]* %12, [240 x i32]* nonnull align 512 %buffer_out_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in([20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [20 x i32]* readonly, [20 x i32]* noalias align 512, [240 x i32]* readonly, [240 x i32]* noalias align 512) unnamed_addr #1 {
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a240i32([240 x i32]* align 512 %25, [240 x i32]* %24)
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a240i32([240 x i32]* noalias align 512, [240 x i32]* noalias readonly) unnamed_addr #2 {
entry:
  %2 = icmp eq [240 x i32]* %0, null
  %3 = icmp eq [240 x i32]* %1, null
  %4 = or i1 %2, %3
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %copy
  %for.loop.idx3 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop ]
  %dst.addr.gep1 = getelementptr [240 x i32], [240 x i32]* %0, i64 0, i64 %for.loop.idx3
  %5 = bitcast i32* %dst.addr.gep1 to i8*
  %src.addr.gep2 = getelementptr [240 x i32], [240 x i32]* %1, i64 0, i64 %for.loop.idx3
  %6 = bitcast i32* %src.addr.gep2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 1 %5, i8* align 1 %6, i64 4, i1 false)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx3, 1
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a240i32([240 x i32]* %24, [240 x i32]* align 512 %25)
  ret void
}

declare void @apatb_MagBramWriter_hw(i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*)

define void @MagBramWriter_hw_stub_wrapper(i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*) #5 {
entry:
  %13 = bitcast i32* %0 to [20 x i32]*
  %14 = bitcast i32* %1 to [20 x i32]*
  %15 = bitcast i32* %2 to [20 x i32]*
  %16 = bitcast i32* %3 to [20 x i32]*
  %17 = bitcast i32* %4 to [20 x i32]*
  %18 = bitcast i32* %5 to [20 x i32]*
  %19 = bitcast i32* %6 to [20 x i32]*
  %20 = bitcast i32* %7 to [20 x i32]*
  %21 = bitcast i32* %8 to [20 x i32]*
  %22 = bitcast i32* %9 to [20 x i32]*
  %23 = bitcast i32* %10 to [20 x i32]*
  %24 = bitcast i32* %11 to [20 x i32]*
  %25 = bitcast i32* %12 to [240 x i32]*
  call void @copy_out([20 x i32]* null, [20 x i32]* %13, [20 x i32]* null, [20 x i32]* %14, [20 x i32]* null, [20 x i32]* %15, [20 x i32]* null, [20 x i32]* %16, [20 x i32]* null, [20 x i32]* %17, [20 x i32]* null, [20 x i32]* %18, [20 x i32]* null, [20 x i32]* %19, [20 x i32]* null, [20 x i32]* %20, [20 x i32]* null, [20 x i32]* %21, [20 x i32]* null, [20 x i32]* %22, [20 x i32]* null, [20 x i32]* %23, [20 x i32]* null, [20 x i32]* %24, [240 x i32]* null, [240 x i32]* %25)
  %26 = bitcast [20 x i32]* %13 to i32*
  %27 = bitcast [20 x i32]* %14 to i32*
  %28 = bitcast [20 x i32]* %15 to i32*
  %29 = bitcast [20 x i32]* %16 to i32*
  ...
  %38 = bitcast [240 x i32]* %25 to i32*
  call void @MagBramWriter_hw_stub(i32* %26, i32* %27, i32* %28, i32* %29, i32* %30, i32* %31, i32* %32, i32* %33, i32* %34, i32* %35, i32* %36, i32* %37, i32* %38)
  call void @copy_in([20 x i32]* null, [20 x i32]* %13, [20 x i32]* null, [20 x i32]* %14, [20 x i32]* null, [20 x i32]* %15, [20 x i32]* null, [20 x i32]* %16, [20 x i32]* null, [20 x i32]* %17, [20 x i32]* null, [20 x i32]* %18, [20 x i32]* null, [20 x i32]* %19, [20 x i32]* null, [20 x i32]* %20, [20 x i32]* null, [20 x i32]* %21, [20 x i32]* null, [20 x i32]* %22, [20 x i32]* null, [20 x i32]* %23, [20 x i32]* null, [20 x i32]* %24, [240 x i32]* null, [240 x i32]* %25)
  ret void
}

declare void @MagBramWriter_hw_stub(i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*)
