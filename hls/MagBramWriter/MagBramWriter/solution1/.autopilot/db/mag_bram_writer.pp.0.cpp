...
void loadBuffer(uint32_t buffer_in[20], uint32_t buffer[20]);
...
void writeData(uint32_t buffer[20], uint32_t buffer_out[20*12], int channel);

__attribute__((sdx_kernel("MagBramWriter", 0))) void MagBramWriter(uint32_t buffer_in_0[20], uint32_t buffer_in_1[20], uint32_t buffer_in_2[20],
...
void writeData(uint32_t buffer[20], uint32_t buffer_out[20*12], int channel) {
 ...
 VITIS_LOOP_95_1: for (int i = 20*channel; i < 20*(channel+1); i++) {

  buffer_out[i] = buffer[i%20];
