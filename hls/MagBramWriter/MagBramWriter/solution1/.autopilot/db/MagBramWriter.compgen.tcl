...
set ID 8
set hasByteEnable 0
set MemName MagBramWriter_buffer_0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 9 \
			corename MagBramWriter_control_axilite \
			name MagBramWriter_control_s_axi \
			ports {$port_control} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler MagBramWriter_control_s_axi
}
