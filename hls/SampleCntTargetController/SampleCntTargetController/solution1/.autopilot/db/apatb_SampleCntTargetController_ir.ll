; ModuleID = '/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/hls/SampleCntTargetController/SampleCntTargetController/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%struct.ssdm_int = type { i20 }

; Function Attrs: noinline
define void @apatb_SampleCntTargetController_ir(%struct.ap_uint* nocapture readonly %sample_cnt_target_in, %struct.ap_uint* %sample_cnt_target_out) local_unnamed_addr #0 {
entry:
  %sample_cnt_target_out_copy1 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %sample_cnt_target_out, %struct.ap_uint* nonnull align 512 %sample_cnt_target_out_copy1)
  call void @apatb_SampleCntTargetController_hw(%struct.ap_uint* %sample_cnt_target_in, %struct.ap_uint* %sample_cnt_target_out_copy1)
  call fastcc void @copy_out(%struct.ap_uint* %sample_cnt_target_out, %struct.ap_uint* nonnull align 512 %sample_cnt_target_out_copy1)
  ret void
}
...
declare void @apatb_SampleCntTargetController_hw(%struct.ap_uint*, %struct.ap_uint*)

define void @SampleCntTargetController_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %1)
  call void @SampleCntTargetController_hw_stub(%struct.ap_uint* %0, %struct.ap_uint* %1)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %1)
  ret void
}

declare void @SampleCntTargetController_hw_stub(%struct.ap_uint*, %struct.ap_uint*)
