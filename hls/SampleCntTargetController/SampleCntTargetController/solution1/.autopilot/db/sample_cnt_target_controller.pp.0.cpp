# 1 "../../src/sample_cnt_target_controller.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../src/sample_cnt_target_controller.cpp" 2
...
# 2 "../../src/sample_cnt_target_controller.cpp" 2
...
# 3 "../../src/sample_cnt_target_controller.cpp" 2

__attribute__((sdx_kernel("SampleCntTargetController", 0))) void SampleCntTargetController(ap_uint<20> sample_cnt_target_in, ap_uint<20> *sample_cnt_target_out)
{
#pragma HLS TOP name=SampleCntTargetController
# 5 "../../src/sample_cnt_target_controller.cpp"
