...
csynth_design
#cosim_design
export_design -rtl vhdl -format ip_catalog -vendor "DIII" -library "PL-Mag-Sensor" -output /vol/Workspace/Projects/PL-Mag-Sensor/ip/SampleCntTargetController.zip
