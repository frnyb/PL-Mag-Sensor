...
set solution_dir "/vol/Workspace/Projects/PL-Mag-Sensor/hls/SampleCntTargetController/SampleCntTargetController/solution1"
set debug_dir "/vol/Workspace/Projects/PL-Mag-Sensor/hls/SampleCntTargetController/SampleCntTargetController/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {SampleCntTargetController_control_s_axi
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 sample_cnt_target_in W 0x0 "Data signal of sample_cnt_target_in" {{0 20 sample_cnt_target_in W 0 "Bit 19 to 0 of sample_cnt_target_in"} {20 12 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
