...
`timescale 1 ns / 1 ps
module SlidingWindowMagSampleFetcher_loadSlidingWindow_sample_period(
    reset,
    clk,
    address0,
    ce0,
...
SlidingWindowMagSampleFetcher_loadSlidingWindow_sample_period_ram SlidingWindowMagSampleFetcher_loadSlidingWindow_sample_period_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .we0( we0 ),
