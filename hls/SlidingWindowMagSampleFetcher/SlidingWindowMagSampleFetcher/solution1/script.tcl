...
add_files -tb ../src/sliding_window_mag_sample_fetcher_test_bench.cpp
...
export_design -rtl vhdl -format ip_catalog -vendor "DIII" -display_name "SlidingWindowMagSampleFetcher" -output /home/ffn/Workspace/Projects/PL-Mag-Sensor/ip/SlidingWindowMagSampleFetcher.zip
