...
$(ObjDir)/sliding_window_mag_sample_fetcher_test_bench.cpp_pre.cpp.tb.o : sliding_window_mag_sample_fetcher_test_bench.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling sliding_window_mag_sample_fetcher_test_bench.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/SlidingWindowMagSampleFetcher.cpp_pre.cpp.tb.o : SlidingWindowMagSampleFetcher.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling SlidingWindowMagSampleFetcher.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
