; ModuleID = '/vol/Workspace/Projects/PL-Mag-Sensor/hls/SlidingWindowMagSampleFetcher/SlidingWindowMagSampleFetcher/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_SlidingWindowMagSampleFetcher_ir(i32* %buffer_in_0, i32* %buffer_in_1, i32* %buffer_in_2, i32* %buffer_in_3, i32* %buffer_in_4, i32* %buffer_in_5, i32* %buffer_in_6, i32* %buffer_in_7, i32* %buffer_in_8, i32* %buffer_in_9, i32* %buffer_in_10, i32* %buffer_in_11, i32* %buffer_out, %struct.ap_uint* nocapture readonly %n_samples, i8 %n_periods, i32* %n_samples_out, i1* %start_write) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_SlidingWindowMagSampleFetcher_hw(i32* %13, i32* %14, i32* %15, i32* %16, i32* %17, i32* %18, i32* %19, i32* %20, i32* %21, i32* %22, i32* %23, i32* %24, i32* %25, %struct.ap_uint* %n_samples, i8 %n_periods, i32* %n_samples_out_copy, i1* %start_write_copy)
...
define internal fastcc void @copy_in([10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [10 x i32]* readonly, [10 x i32]* noalias align 512, [3840 x i32]* readonly, [3840 x i32]* noalias, i32* readonly, i32* noalias align 512, i1* readonly, i1* noalias align 512) unnamed_addr #1 {
entry:
...
declare void @apatb_SlidingWindowMagSampleFetcher_hw(i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, %struct.ap_uint*, i8, i32*, i1*)

define void @SlidingWindowMagSampleFetcher_hw_stub_wrapper(i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, %struct.ap_uint*, i8, i32*, i1*) #5 {
entry:
  %17 = bitcast i32* %0 to [10 x i32]*
  %18 = bitcast i32* %1 to [10 x i32]*
  %19 = bitcast i32* %2 to [10 x i32]*
  %20 = bitcast i32* %3 to [10 x i32]*
  %21 = bitcast i32* %4 to [10 x i32]*
  %22 = bitcast i32* %5 to [10 x i32]*
  %23 = bitcast i32* %6 to [10 x i32]*
  %24 = bitcast i32* %7 to [10 x i32]*
  %25 = bitcast i32* %8 to [10 x i32]*
  %26 = bitcast i32* %9 to [10 x i32]*
  %27 = bitcast i32* %10 to [10 x i32]*
  %28 = bitcast i32* %11 to [10 x i32]*
  %29 = bitcast i32* %12 to [3840 x i32]*
  call void @copy_out([10 x i32]* null, [10 x i32]* %17, [10 x i32]* null, [10 x i32]* %18, [10 x i32]* null, [10 x i32]* %19, [10 x i32]* null, [10 x i32]* %20, [10 x i32]* null, [10 x i32]* %21, [10 x i32]* null, [10 x i32]* %22, [10 x i32]* null, [10 x i32]* %23, [10 x i32]* null, [10 x i32]* %24, [10 x i32]* null, [10 x i32]* %25, [10 x i32]* null, [10 x i32]* %26, [10 x i32]* null, [10 x i32]* %27, [10 x i32]* null, [10 x i32]* %28, [3840 x i32]* null, [3840 x i32]* %29, i32* null, i32* %15, i1* null, i1* %16)
  ...
  %42 = bitcast [3840 x i32]* %29 to i32*
  call void @SlidingWindowMagSampleFetcher_hw_stub(i32* %30, i32* %31, i32* %32, i32* %33, i32* %34, i32* %35, i32* %36, i32* %37, i32* %38, i32* %39, i32* %40, i32* %41, i32* %42, %struct.ap_uint* %13, i8 %14, i32* %15, i1* %16)
  call void @copy_in([10 x i32]* null, [10 x i32]* %17, [10 x i32]* null, [10 x i32]* %18, [10 x i32]* null, [10 x i32]* %19, [10 x i32]* null, [10 x i32]* %20, [10 x i32]* null, [10 x i32]* %21, [10 x i32]* null, [10 x i32]* %22, [10 x i32]* null, [10 x i32]* %23, [10 x i32]* null, [10 x i32]* %24, [10 x i32]* null, [10 x i32]* %25, [10 x i32]* null, [10 x i32]* %26, [10 x i32]* null, [10 x i32]* %27, [10 x i32]* null, [10 x i32]* %28, [3840 x i32]* null, [3840 x i32]* %29, i32* null, i32* %15, i1* null, i1* %16)
  ret void
}

declare void @SlidingWindowMagSampleFetcher_hw_stub(i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, i32*, %struct.ap_uint*, i8, i32*, i1*)
