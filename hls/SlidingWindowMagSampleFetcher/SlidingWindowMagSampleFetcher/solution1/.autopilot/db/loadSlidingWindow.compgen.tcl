...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    id 16 \
    name sliding_window_buffer_1 \
    reset_level 1 \
    sync_rst true \
    dir O \
    corename sliding_window_buffer_1 \
    op interface \
    ports { sliding_window_buffer_1_address0 { O 5 vector } sliding_window_buffer_1_ce0 { O 1 bit } sliding_window_buffer_1_we0 { O 1 bit } sliding_window_buffer_1_d0 { O 6 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'sliding_window_buffer_1'"
}
}
