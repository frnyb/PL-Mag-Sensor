# 1 "../src/SlidingWindowMagSampleFetcher.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../src/SlidingWindowMagSampleFetcher.cpp" 2
...
# 7 "../src/SlidingWindowMagSampleFetcher.cpp" 2
...
# 9 "../src/SlidingWindowMagSampleFetcher.cpp" 2
# 1 "../src/sample_period.h" 1
...
public:
 ...
 SamplePeriod(sample_t samples[max_n_samples], int count) {
  ...
  VITIS_LOOP_18_1: for (int i = 0; i < count; i++) {
...
# 10 "../src/SlidingWindowMagSampleFetcher.cpp" 2


# 1 "../src/test_class.h" 1
class test {
public:
 test();
...
# 13 "../src/SlidingWindowMagSampleFetcher.cpp" 2
# 30 "../src/SlidingWindowMagSampleFetcher.cpp"
void loadSlidingWindow(uint32_t buffer_in_0[10], uint32_t buffer_in_1[10], uint32_t buffer_in_2[10],
  uint32_t buffer_in_3[10], uint32_t buffer_in_4[10], uint32_t buffer_in_5[10],
  uint32_t buffer_in_6[10], uint32_t buffer_in_7[10], uint32_t buffer_in_8[10],
  uint32_t buffer_in_9[10], uint32_t buffer_in_10[10], uint32_t buffer_in_11[10],
  CyclicBuffer<SamplePeriod<10>, 32> *sliding_window, int n_samples);

void writeToRAM(uint32_t buffer_out[12*10*32], CyclicBuffer<SamplePeriod<10>, 32> *sliding_window,
  uint32_t * n_samples_out, int n_periods);
# 49 "../src/SlidingWindowMagSampleFetcher.cpp"
__attribute__((sdx_kernel("SlidingWindowMagSampleFetcher", 0))) void SlidingWindowMagSampleFetcher(uint32_t buffer_in_0[10], uint32_t buffer_in_1[10], uint32_t buffer_in_2[10],
  uint32_t buffer_in_3[10], uint32_t buffer_in_4[10], uint32_t buffer_in_5[10],
  uint32_t buffer_in_6[10], uint32_t buffer_in_7[10], uint32_t buffer_in_8[10],
  uint32_t buffer_in_9[10], uint32_t buffer_in_10[10], uint32_t buffer_in_11[10],
  uint32_t buffer_out[12*10*32], uint8_t n_periods, volatile bool *bfr_irq, volatile ap_uint<6> *n_samples, uint32_t *n_samples_out,
  volatile bool *start_write, volatile bool *write_finished) {_ssdm_SpecArrayDimSize(buffer_in_0, 10);_ssdm_SpecArrayDimSize(buffer_in_1, 10);_ssdm_SpecArrayDimSize(buffer_in_2, 10);_ssdm_SpecArrayDimSize(buffer_in_3, 10);_ssdm_SpecArrayDimSize(buffer_in_4, 10);_ssdm_SpecArrayDimSize(buffer_in_5, 10);_ssdm_SpecArrayDimSize(buffer_in_6, 10);_ssdm_SpecArrayDimSize(buffer_in_7, 10);_ssdm_SpecArrayDimSize(buffer_in_8, 10);_ssdm_SpecArrayDimSize(buffer_in_9, 10);_ssdm_SpecArrayDimSize(buffer_in_10, 10);_ssdm_SpecArrayDimSize(buffer_in_11, 10);_ssdm_SpecArrayDimSize(buffer_out, 3840);
#pragma HLS TOP name=SlidingWindowMagSampleFetcher
# 54 "../src/SlidingWindowMagSampleFetcher.cpp"
...
void loadSlidingWindow(uint32_t buffer_in_0[10], uint32_t buffer_in_1[10], uint32_t buffer_in_2[10],
 ...
 load_loop: for (int i = 0; i < n_samples; i++) {
  ...
  VITIS_LOOP_138_1: for (int j = 0; j < 12; j++) {
 ...
 SamplePeriod<10> sample_period(samples, n_samples);
...
void writeToRAM(uint32_t buffer_out[12*10*32], CyclicBuffer<SamplePeriod<10>, 32> *sliding_window,
  uint32_t * n_samples_out, int n_periods) {
# 171 "../src/SlidingWindowMagSampleFetcher.cpp"
}
