...
# 2 "<built-in>" 2
# 1 "../src/SineParamFinder.cpp" 2
# 1 "../src/SineParamFinder.h" 1
...
__attribute__((sdx_kernel("SineParamFinder", 0))) void SineParamFinder(uint16_t n_samples, uint32_t samples[1000], ap_uint<4> channel,
  sample_t *amplitude, time_t *offset);
# 2 "../src/SineParamFinder.cpp" 2

__attribute__((sdx_kernel("SineParamFinder", 0))) void SineParamFinder(uint16_t n_samples, uint32_t samples[1000], ap_uint<4> channel,
  sample_t *amplitude, time_t *offset) {_ssdm_SpecArrayDimSize(samples, 1000);
#pragma HLS TOP name=SineParamFinder
# 4 "../src/SineParamFinder.cpp"
...
#pragma HLS TOP name=SineParamFinder
 ...
 loop: for (int i = 0; i < n_samples; i++) {
  ...
  sample_t val_ = (sample_t)(samples[i] & 0x00000FFF);
  time_t offset_ = (time_t)((samples[i] >> 12) & 0x00000FFF);
