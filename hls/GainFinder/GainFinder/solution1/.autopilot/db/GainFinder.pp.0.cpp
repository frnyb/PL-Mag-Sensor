...
# 2 "<built-in>" 2
# 1 "../src/GainFinder.cpp" 2
# 1 "../src/GainFinder.h" 1
# 1 "../src/defines.h" 1
# 2 "../src/GainFinder.h" 2
# 1 "../src/data_types.h" 1
...
typedef ap_uint<10 +1> sample_count_t;
...
# 3 "../src/GainFinder.h" 2
# 1 "../src/comp_top_lut.h" 1


int frac_lut_length = 38;

fraction_t saturation_fraction[38] = {0.065,0.075,0.085,0.095,0.105,0.115,0.125,0.135,0.145,0.155,0.165,0.175,0.185,0.195,0.205,0.215,0.225,0.235,0.245,0.255,0.265,0.275,0.285,0.295,0.305,0.315,0.325,0.335,0.345,0.355,0.365,0.375,0.385,0.395,0.405,0.415,0.425,0.435};

sample_L_t comp_tops[38] = {2000,2008,2024,2042,2063,2087,2113,2142,2174,2209,2247,2289,2336,2386,2441,2502,2568,2640,2719,2806,2901,3007,3123,3252,3396,3557,3738,3943,4175,4442,4750,5109,5532,6039,6656,7423,8399,9474};
# 4 "../src/GainFinder.h" 2


# 1 "/tools/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_int.h" 1
# 7 "../src/GainFinder.h" 2



__attribute__((sdx_kernel("GainFinder", 0))) void GainFinder(sample_t signal_top_val, sample_count_t n_samples_sat, sample_count_t n_samples, gain_step_t curr_gain, gain_step_t *new_gain);
...
# 2 "../src/GainFinder.cpp" 2

__attribute__((sdx_kernel("GainFinder", 0))) void GainFinder(sample_t signal_top_val, sample_count_t n_samples_sat, sample_count_t n_samples, gain_step_t curr_gain, gain_step_t *new_gain) {
#pragma HLS TOP name=GainFinder
# 3 "../src/GainFinder.cpp"
...
#pragma HLS INTERFACE ap_vld port=new_gain
 ...
 if (signal_top_val > 0xE00) {

  up_not_down = false;

 } else if (signal_top_val < 0xA00) {
...
void findGain(sample_L_t signal_top_val, gain_step_t curr_gain, gain_step_t *new_gain) {
 ...
 sample_fixed_t ampl_no_gain = signal_ampl / ((sample_fixed_t)(2. * curr_gain + 1.));

 gain_step_comp_t req_gain = ((gain_step_comp_t)((sample_fixed_t)0xC00)/(ampl_no_gain));
...
sample_L_t lookupTop(fraction_t sat_frac) {
 ...
 VITIS_LOOP_86_1: for (int i = 0; i < frac_lut_length; i++) {
