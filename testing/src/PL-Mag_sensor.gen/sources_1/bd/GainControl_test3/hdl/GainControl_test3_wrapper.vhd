...
entity GainControl_test3_wrapper is
  port (
...
end GainControl_test3_wrapper;

architecture STRUCTURE of GainControl_test3_wrapper is
  component GainControl_test3 is
  port (
    ch_out : out STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
    gain : out STD_LOGIC_VECTOR ( 5 downto 0 );
...
begin
GainControl_test3_i: component GainControl_test3
     port map (
