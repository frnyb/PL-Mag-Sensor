...
-- Date        : Mon Feb 14 10:47:58 2022
-- Host        : adm-59955 running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/vivado/PL-Mag-Sensor/PL-Mag-Sensor.gen/sources_1/bd/GainControl_test6/ip/GainControl_test6_sample_time_counter_0/GainControl_test6_sample_time_counter_0_sim_netlist.vhdl
-- Design      : GainControl_test6_sample_time_counter_0
...
entity GainControl_test6_sample_time_counter_0_counter is
  port (
  ...
  attribute ORIG_REF_NAME of GainControl_test6_sample_time_counter_0_counter : entity is "counter";
end GainControl_test6_sample_time_counter_0_counter;

architecture STRUCTURE of GainControl_test6_sample_time_counter_0_counter is
...
\cnt_int1_carry__0\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(1) => \cnt_int1_carry__0_i_1_n_0\,
      DI(0) => \cnt_int1_carry__0_i_2_n_0\,
      O(7 downto 0) => \NLW_cnt_int1_carry__0_O_UNCONNECTED\(7 downto 0),
      S(7 downto 2) => B"000000",
      S(1) => \cnt_int1_carry__0_i_3_n_0\,
      S(0) => \cnt_int1_carry__0_i_4_n_0\
    );
\cnt_int1_carry__0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2F02"
    )
        port map (
...
\cnt_int1_carry__0_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\cnt_int[19]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GainControl_test6_sample_time_counter_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of GainControl_test6_sample_time_counter_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of GainControl_test6_sample_time_counter_0 : entity is "GainControl_test6_sample_time_counter_0,counter,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of GainControl_test6_sample_time_counter_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of GainControl_test6_sample_time_counter_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of GainControl_test6_sample_time_counter_0 : entity is "counter,Vivado 2020.2";
end GainControl_test6_sample_time_counter_0;

architecture STRUCTURE of GainControl_test6_sample_time_counter_0 is
...
begin
U0: entity work.GainControl_test6_sample_time_counter_0_counter
     port map (
      clk => clk,
      cnt(19 downto 0) => cnt(19 downto 0),
      en => en,
