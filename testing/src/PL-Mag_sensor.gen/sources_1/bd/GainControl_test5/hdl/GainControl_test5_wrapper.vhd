...
--Date        : Mon Feb 14 10:02:02 2022
--Host        : adm-59955 running 64-bit Ubuntu 20.04.3 LTS
--Command     : generate_target GainControl_test5_wrapper.bd
--Design      : GainControl_test5_wrapper
...
entity GainControl_test5_wrapper is
  port (
...
end GainControl_test5_wrapper;

architecture STRUCTURE of GainControl_test5_wrapper is
  component GainControl_test5 is
  port (
    ch_out : out STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
    gain : out STD_LOGIC_VECTOR ( 5 downto 0 );
  ...
  end component GainControl_test5;
begin
GainControl_test5_i: component GainControl_test5
     port map (
