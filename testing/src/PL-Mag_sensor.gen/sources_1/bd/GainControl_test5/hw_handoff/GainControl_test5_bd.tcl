...
################################################################
# This is a generated script based on design: GainControl_test5
#
...
# source GainControl_test5_script.tcl
...
set design_name GainControl_test5
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net gain_const_dout [get_bd_pins gain_concat/In0] [get_bd_pins gain_concat/In1] [get_bd_pins gain_concat/In2] [get_bd_pins gain_const/dout]
  connect_bd_net -net gain_controller_0_gain [get_bd_ports gain] [get_bd_pins gain_concat/In3] [get_bd_pins gain_controller/gain]
  connect_bd_net -net gain_controller_adc_UnD_ref [get_bd_pins UnD_ref_concat/In3] [get_bd_pins gain_controller/adc_UnD_ref]
  connect_bd_net -net gain_controller_adc_nCS_ref [get_bd_pins gain_controller/adc_nCS_ref] [get_bd_pins nCS_ref_concat/In3]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins UnD_ref_concat/In0] [get_bd_pins UnD_ref_concat/In1] [get_bd_pins UnD_ref_concat/In2] [get_bd_pins gpio_const/dout] [get_bd_pins nCS_ref_concat/In0] [get_bd_pins nCS_ref_concat/In1] [get_bd_pins nCS_ref_concat/In2]
