...
--Command     : generate_target GainController_test4.bd
--Design      : GainController_test4
...
entity ADCControl_imp_8JJ3LL is
  port (
...
end ADCControl_imp_8JJ3LL;

architecture STRUCTURE of ADCControl_imp_8JJ3LL is
  component GainController_test4_ADC_controller_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    spi_cs : out STD_LOGIC;
  ...
  end component GainController_test4_ADC_controller_0;
  component GainController_test4_sample_time_counter_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  end component GainController_test4_sample_time_counter_0;
  component GainController_test4_SampleTimeLUT_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 5 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 19 downto 0 )
  );
  end component GainController_test4_SampleTimeLUT_0;
  component GainController_test4_max_gain_0 is
  port (
    gains : in STD_LOGIC_VECTOR ( 23 downto 0 );
    max_gain_out : out STD_LOGIC_VECTOR ( 5 downto 0 )
  );
  end component GainController_test4_max_gain_0;
  component GainController_test4_ADC_simulator_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    spi_rw : in STD_LOGIC;
  ...
  end component GainController_test4_ADC_simulator_0;
...
ADC_controller: component GainController_test4_ADC_controller_0
     port map (
      ch_out(3 downto 0) => ADC_controller_0_ch_out(3 downto 0),
      clk => clk_0_1,
...
ADC_simulator: component GainController_test4_ADC_simulator_0
     port map (
      clk => clk_0_1,
      rst_n => rst_n_0_1,
      spi_addr(1 downto 0) => ADC_controller_0_spi_addr(1 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GainController_test4 is
  port (
    ch_out : out STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
  ...
  attribute core_generation_info of GainController_test4 : entity is "GainController_test4,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=GainController_test4,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=14,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute hw_handoff : string;
  attribute hw_handoff of GainController_test4 : entity is "GainController_test4.hwdef";
end GainController_test4;

architecture STRUCTURE of GainController_test4 is
  component GainController_test4_UnD_ref_concat_0 is
  port (
  ...
  end component GainController_test4_UnD_ref_concat_0;
  component GainController_test4_UnD_slice_0 is
  port (
    Din : in STD_LOGIC_VECTOR ( 3 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component GainController_test4_UnD_slice_0;
  component GainController_test4_gain_concat_0 is
  port (
  ...
  end component GainController_test4_gain_concat_0;
  component GainController_test4_gain_const_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 5 downto 0 )
  );
  end component GainController_test4_gain_const_0;
  component GainController_test4_gain_controller_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
  ...
  end component GainController_test4_gain_controller_0;
  component GainController_test4_gpio_const_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component GainController_test4_gpio_const_0;
  component GainController_test4_nCS_ref_concat_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In2 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component GainController_test4_nCS_ref_concat_0;
  component GainController_test4_nCS_slice_0 is
  port (
    Din : in STD_LOGIC_VECTOR ( 3 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component GainController_test4_nCS_slice_0;
  signal ADC_controller_0_ch_out : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal ADC_controller_0_gpio_UnD : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal ADC_controller_0_gpio_nCS : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal ADC_controller_0_irq_out : STD_LOGIC;
  ...
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN GainController_test4_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
...
begin
  ...
  t_sample_en <= ADC_controller_t_sample_en;
  t_sample_irq <= sample_time_counter_irq;
ADCControl: entity work.ADCControl_imp_8JJ3LL
     port map (
      ch_out(3 downto 0) => ADC_controller_0_ch_out(3 downto 0),
      clk => clk_0_1,
      gains(23 downto 0) => curr_gain_1(23 downto 0),
...
gpio_const: component GainController_test4_gpio_const_0
     port map (
      dout(0) => xlconstant_0_dout(0)
    );
nCS_ref_concat: component GainController_test4_nCS_ref_concat_0
     port map (
      In0(0) => xlconstant_0_dout(0),
      In1(0) => xlconstant_0_dout(0),
      In2(0) => gain_controller_adc_nCS_ref,
      In3(0) => xlconstant_0_dout(0),
      dout(3 downto 0) => gpio_nCS_ref_1(3 downto 0)
    );
nCS_slice: component GainController_test4_nCS_slice_0
     port map (
