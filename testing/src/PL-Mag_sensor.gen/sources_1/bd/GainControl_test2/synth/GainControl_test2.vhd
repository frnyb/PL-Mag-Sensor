...
architecture STRUCTURE of GainControl_test2 is
  component GainControl_test2_SampleTimeLUT_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 5 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 19 downto 0 )
  );
  end component GainControl_test2_SampleTimeLUT_0;
  ...
  component GainControl_test2_gain_concat_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 5 downto 0 );
    In1 : in STD_LOGIC_VECTOR ( 17 downto 0 );
    dout : out STD_LOGIC_VECTOR ( 23 downto 0 )
  );
  end component GainControl_test2_gain_concat_0;
  component GainControl_test2_gain_const_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 17 downto 0 )
  );
  end component GainControl_test2_gain_const_0;
  component GainControl_test2_gain_controller_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
  ...
  end component GainControl_test2_gain_controller_0;
  component GainControl_test2_gpio_const_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 2 downto 0 )
  );
  end component GainControl_test2_gpio_const_0;
  component GainControl_test2_max_gain_0 is
  port (
    gains : in STD_LOGIC_VECTOR ( 23 downto 0 );
    max_gain_out : out STD_LOGIC_VECTOR ( 5 downto 0 )
  );
  end component GainControl_test2_max_gain_0;
  ...
  component GainControl_test2_nCS_slice_0 is
  port (
    Din : in STD_LOGIC_VECTOR ( 3 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component GainControl_test2_nCS_slice_0;
  component GainControl_test2_sample_time_counter_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  end component GainControl_test2_sample_time_counter_0;
  component GainControl_test2_ADC_controller_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    spi_cs : out STD_LOGIC;
  ...
  end component GainControl_test2_ADC_controller_0;
  component GainControl_test2_ADC_simulator_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    spi_rw : in STD_LOGIC;
  ...
  end component GainControl_test2_ADC_simulator_0;
...
ADC_controller: component GainControl_test2_ADC_controller_0
     port map (
      ch_out(3 downto 0) => ADC_controller_0_ch_out(3 downto 0),
      clk => clk_0_1,
...
ADC_simulator: component GainControl_test2_ADC_simulator_0
     port map (
      clk => clk_0_1,
      rst_n => rst_n_0_1,
      spi_addr(1 downto 0) => ADC_controller_0_spi_addr(1 downto 0),
...
gain_const: component GainControl_test2_gain_const_0
     port map (
      dout(17 downto 0) => xlconstant_1_dout(17 downto 0)
    );
gain_controller: component GainControl_test2_gain_controller_0
     port map (
