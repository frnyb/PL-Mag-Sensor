%% Measurements
D_vj = zeros(3,4);
D_vj(:,1) = [1.515539 41.119987 19.673582];
D_vj(:,2) = [0.880459 24.161255 24.169281];
D_vj(:,3) = [0.664315 25.513767 22.643015];
D_vj(:,4) = [-5.876610 47.408783 19.944782];
...
J = matlabFunction(jacobian([P_B_j(2:3,1);P_B_j(2:3,2);P_B_j(2:3,3);P_B_j(2:3,4)], [P1_D_py P1_D_pz]));
