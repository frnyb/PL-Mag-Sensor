...
entity ControlGain is
generic (
    C_S_AXI_CPU_ADDR_WIDTH : INTEGER := 5;
    C_S_AXI_CPU_DATA_WIDTH : INTEGER := 32 );
port (
    gain_ref_out : OUT STD_LOGIC_VECTOR (7 downto 0);
...
architecture behav of ControlGain is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "ControlGain_ControlGain,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu3eg-sbva484-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.000000,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=64,HLS_SYN_LUT=72,HLS_VERSION=2020_2}";
    ...
    signal gain_ref_in : STD_LOGIC_VECTOR (7 downto 0);
    signal gain_out_ap_vld : STD_LOGIC;
    signal ap_rst_n_inv : STD_LOGIC;
    signal ap_ce_reg : STD_LOGIC;

    component ControlGain_CPU_s_axi IS
    generic (
...
begin
    CPU_s_axi_U : component ControlGain_CPU_s_axi
    generic map (
    ...
    port map (
        ...
        gain_ref_in => gain_ref_in,
        gain_out => gain_in,
        gain_out_ap_vld => gain_out_ap_vld,
        ap_start => ap_start,
        interrupt => interrupt,
        ap_ready => ap_ready,
        ap_done => ap_done,
    ...
    gain_out_ap_vld_assign_proc : process(ap_start)
    begin
        if ((ap_start = ap_const_logic_1)) then 
            gain_out_ap_vld <= ap_const_logic_1;
        else 
            gain_out_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
