...
entity ADCControl_inst_0 is
  ...
  attribute CORE_GENERATION_INFO of ADCControl_inst_0 : entity is "ADCControl_inst_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ADCControl_inst_0,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/vivado/ADCControl/ADCControl.srcs/sources_1/bd/ADCControl/ADCControl.bd,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of ADCControl_inst_0 is
  component ADCControl_inst_0_max_gain_0 is
  port (
    gains : in STD_LOGIC_VECTOR ( 23 downto 0 );
    max_gain_out : out STD_LOGIC_VECTOR ( 5 downto 0 )
  );
  end component ADCControl_inst_0_max_gain_0;
  component ADCControl_inst_0_counter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  end component ADCControl_inst_0_counter_0_0;
  component ADCControl_inst_0_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 19 downto 0 )
  );
  end component ADCControl_inst_0_xlconstant_0_0;
...
counter_0: component ADCControl_inst_0_counter_0_0
     port map (
      clk => clka_0_1,
