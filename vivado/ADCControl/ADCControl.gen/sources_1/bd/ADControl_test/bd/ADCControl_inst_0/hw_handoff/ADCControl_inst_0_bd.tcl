...
if { ${design_name} eq "" } {
   ...
   create_bd_design -bdsource /home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/vivado/ADCControl/ADCControl.srcs/sources_1/bd/ADCControl/ADCControl.bd $design_name
