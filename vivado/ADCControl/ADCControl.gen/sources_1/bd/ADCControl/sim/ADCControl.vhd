...
entity ADCControl is
  ...
  attribute CORE_GENERATION_INFO of ADCControl : entity is "ADCControl,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ADCControl,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of ADCControl is
  ...
  signal target_0_1 : STD_LOGIC_VECTOR ( 19 downto 0 );
...
begin
  ...
  target_0_1(19 downto 0) <= sample_cnt_target(19 downto 0);
...
counter_0: component ADCControl_counter_0_2
     port map (
      ...
      rst_n => rst_n_0_1,
      target(19 downto 0) => target_0_1(19 downto 0)
    );
end STRUCTURE;
