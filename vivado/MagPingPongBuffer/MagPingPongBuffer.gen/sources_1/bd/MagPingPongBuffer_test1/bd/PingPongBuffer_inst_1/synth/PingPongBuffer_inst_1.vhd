...
--Command     : generate_target PingPongBuffer_inst_1.bd
--Design      : PingPongBuffer_inst_1
...
entity PingPongBuffer_inst_1 is
  port (
    busy : out STD_LOGIC;
    clk : in STD_LOGIC;
    hold : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of PingPongBuffer_inst_1 : entity is "PingPongBuffer_inst_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PingPongBuffer_inst_1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/vivado/MagPingPongBuffer/MagPingPongBuffer.srcs/sources_1/bd/PingPongBuffer/PingPongBuffer.bd,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of PingPongBuffer_inst_1 : entity is "PingPongBuffer_inst_1.hwdef";
end PingPongBuffer_inst_1;

architecture STRUCTURE of PingPongBuffer_inst_1 is
  component PingPongBuffer_inst_1_pingpong_buffer_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  end component PingPongBuffer_inst_1_pingpong_buffer_0_0;
  component PingPongBuffer_inst_1_instant_ram_0_0 is
  port (
    rst_n : in STD_LOGIC;
  ...
  end component PingPongBuffer_inst_1_instant_ram_0_0;
  component PingPongBuffer_inst_1_instant_ram_1_0 is
  port (
    rst_n : in STD_LOGIC;
    din : in STD_LOGIC_VECTOR ( 31 downto 0 );
    dout : out STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component PingPongBuffer_inst_1_instant_ram_1_0;
  signal clk_0_1 : STD_LOGIC;
  signal hold_1 : STD_LOGIC;
  signal instant_ram_0_dout : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal instant_ram_1_dout : STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  signal wr_din_1 : STD_LOGIC_VECTOR ( 11 downto 0 );
...
begin
  ...
  wr_din_1(11 downto 0) <= wr_din(11 downto 0);
instant_ram_0: component PingPongBuffer_inst_1_instant_ram_0_0
     port map (
      addr(4 downto 0) => pingpong_buffer_0_ram0_addr(4 downto 0),
      din(31 downto 0) => pingpong_buffer_0_ram0_dout(31 downto 0),
      dout(31 downto 0) => instant_ram_0_dout(31 downto 0),
      rst_n => rst_n_1,
      wr => pingpong_buffer_0_ram0_wr
    );
instant_ram_1: component PingPongBuffer_inst_1_instant_ram_1_0
     port map (
      addr(4 downto 0) => pingpong_buffer_0_ram1_addr(4 downto 0),
      din(31 downto 0) => pingpong_buffer_0_ram1_dout(31 downto 0),
      dout(31 downto 0) => instant_ram_1_dout(31 downto 0),
      rst_n => rst_n_1,
      wr => pingpong_buffer_0_ram1_wr
    );
pingpong_buffer_0: component PingPongBuffer_inst_1_pingpong_buffer_0_0
     port map (
      busy => pingpong_buffer_0_busy,
      clk => clk_0_1,
      hold => hold_1,
      ...
      ram0_din(31 downto 0) => instant_ram_0_dout(31 downto 0),
      ...
      ram1_din(31 downto 0) => instant_ram_1_dout(31 downto 0),
      ...
      wr_din(31 downto 12) => B"00000000000000000000",
      wr_din(11 downto 0) => wr_din_1(11 downto 0)
    );
end STRUCTURE;
