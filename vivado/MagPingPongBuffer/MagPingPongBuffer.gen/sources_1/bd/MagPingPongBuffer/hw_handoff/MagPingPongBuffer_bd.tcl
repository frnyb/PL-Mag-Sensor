...
################################################################
# This is a generated script based on design: MagPingPongBuffer
#
...
# source MagPingPongBuffer_script.tcl
...
set design_name MagPingPongBuffer
...
proc create_root_design { parentCell } {
  ...
  set ram_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 ram_0 ]
  set_property -dict [ list \
  ...
  # Create instance: ram_1, and set properties
  set ram_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 ram_1 ]
  set_property -dict [ list \
   CONFIG.Enable_32bit_Address {false} \
   CONFIG.Enable_A {Always_Enabled} \
   CONFIG.Fill_Remaining_Memory_Locations {true} \
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins pingpong_buffer_0/clk] [get_bd_pins ram_0/clka] [get_bd_pins ram_1/clka]
  ...
  connect_bd_net -net pingpong_buffer_0_ram0_addr [get_bd_pins pingpong_buffer_0/ram0_addr] [get_bd_pins ram_1/addra]
  connect_bd_net -net pingpong_buffer_0_ram0_dout [get_bd_pins pingpong_buffer_0/ram0_dout] [get_bd_pins ram_1/dina]
  connect_bd_net -net pingpong_buffer_0_ram0_wr [get_bd_pins pingpong_buffer_0/ram0_wr] [get_bd_pins ram_1/wea]
  connect_bd_net -net pingpong_buffer_0_ram1_addr [get_bd_pins pingpong_buffer_0/ram1_addr] [get_bd_pins ram_0/addra]
  connect_bd_net -net pingpong_buffer_0_ram1_dout [get_bd_pins pingpong_buffer_0/ram1_dout] [get_bd_pins ram_0/dina]
  connect_bd_net -net pingpong_buffer_0_ram1_wr [get_bd_pins pingpong_buffer_0/ram1_wr] [get_bd_pins ram_0/wea]
  connect_bd_net -net pingpong_buffer_0_rd_dout [get_bd_ports rd_dout] [get_bd_pins pingpong_buffer_0/rd_dout]
  connect_bd_net -net ram_0_douta [get_bd_pins pingpong_buffer_0/ram1_din] [get_bd_pins ram_0/douta]
  connect_bd_net -net ram_1_douta [get_bd_pins pingpong_buffer_0/ram0_din] [get_bd_pins ram_1/douta]
  connect_bd_net -net rd_addr_1 [get_bd_ports rd_addr] [get_bd_pins pingpong_buffer_0/rd_addr]
  connect_bd_net -net rst_n_1 [get_bd_ports rst_n] [get_bd_pins pingpong_buffer_0/rst_n]
