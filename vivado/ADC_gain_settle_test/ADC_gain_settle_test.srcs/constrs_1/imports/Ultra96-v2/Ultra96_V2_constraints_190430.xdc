...
# ----------------------------------------------------------------------------
# Bank 65
#set_property -dict {PACKAGE_PIN D7 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST} [get_ports {IWR_DIN              }];  # "D7.HD_GPIO_0"
set_property -dict {PACKAGE_PIN F8 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_MOSI} ];  # "F8.HD_GPIO_1"
set_property -dict {PACKAGE_PIN F7 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_MISO} ];  # "F7.HD_GPIO_2"
set_property -dict {PACKAGE_PIN G7 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_nCS0[0]} ];  # "G7.HD_GPIO_3"
set_property -dict {PACKAGE_PIN F6 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_SCLK}];  # "F6.HD_GPIO_4"
#set_property PACKAGE_PIN G5   [get_ports {HD_GPIO_5              }];  # "G5.HD_GPIO_5"
#set_property -dict {PACKAGE_PIN A6 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_nCS1} ];  # "A6.HD_GPIO_6"
#set_property -dict {PACKAGE_PIN A7 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_SCLK1} ];  # "A7.HD_GPIO_7"
#set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {IMU_MOSI} ];  # "G6.HD_GPIO_8"
#set_property -dict {PACKAGE_PIN E6 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_nCS2} ];  # "E6.HD_GPIO_9"
#set_property -dict {PACKAGE_PIN E5 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_SCLK2} ];  # "E5.HD_GPIO_10"
#set_property -dict {PACKAGE_PIN D6 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_nCS3} ];  # "D6.HD_GPIO_11"
#set_property -dict {PACKAGE_PIN D5 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {MAG_SCLK3} ];  # "D5.HD_GPIO_12"
#set_property -dict {PACKAGE_PIN C7 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {IMU_nCS} ];  # "C7.HD_GPIO_13"
set_property -dict {PACKAGE_PIN B6 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {axis_rd_out[0]} ];  # "B6.HD_GPIO_14"
set_property -dict {PACKAGE_PIN C5 IOSTANDARD LVCMOS18 DRIVE 16 SLEW FAST}   [get_ports {axis_rd_out[1]} ];  # "C5.HD_GPIO_15"
