...
module GainControl_imp_4C5IOH
  ...
  MagController_gain_controller_0_0 gain_controller_0
       (.adc_UnD(UnD_slice_0_Dout),
        ...
        .clk(clk_0_1),
        .gain_ref({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .rst_n(rst_n_0_1));
...
(* CORE_GENERATION_INFO = "MagController,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=MagController,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=44,numReposBlks=39,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=2,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=25,numPkgbdBlks=1,bdsource=USER,da_clkrst_cnt=5,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "MagController.hwdef" *) 
