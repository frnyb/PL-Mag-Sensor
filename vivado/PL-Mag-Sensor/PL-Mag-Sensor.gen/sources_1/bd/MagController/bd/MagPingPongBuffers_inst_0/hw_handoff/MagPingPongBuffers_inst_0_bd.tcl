...
################################################################
# This is a generated script based on design: MagPingPongBuffers_inst_0
#
...
# source MagPingPongBuffers_inst_0_script.tcl
...
set design_name MagPingPongBuffers_inst_0
...
if { ${design_name} eq "" } {
   ...
   create_bd_design -bdsource /vol/Workspace/Projects/PL-Mag-Sensor/vivado/PL-Mag-Sensor/PL-Mag-Sensor.srcs/sources_1/bd/MagPingPongBuffers/MagPingPongBuffers.bd $design_name
