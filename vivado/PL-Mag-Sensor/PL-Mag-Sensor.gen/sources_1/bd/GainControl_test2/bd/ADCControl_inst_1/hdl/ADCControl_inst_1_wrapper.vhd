...
--Command     : generate_target ADCControl_inst_1_wrapper.bd
--Design      : ADCControl_inst_1_wrapper
...
entity ADCControl_inst_1_wrapper is
  port (
...
end ADCControl_inst_1_wrapper;

architecture STRUCTURE of ADCControl_inst_1_wrapper is
  component ADCControl_inst_1 is
  port (
    ch_out : out STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
    curr_gain : in STD_LOGIC_VECTOR ( 23 downto 0 );
  ...
  end component ADCControl_inst_1;
begin
ADCControl_inst_1_i: component ADCControl_inst_1
     port map (
