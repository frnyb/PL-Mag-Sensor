...
--Date        : Fri Feb  4 15:42:03 2022
--Host        : adm-59955 running 64-bit Ubuntu 20.04.3 LTS
--Command     : generate_target ADCControl_inst_1.bd
--Design      : ADCControl_inst_1
...
entity ADCControl_inst_1 is
  ...
  attribute CORE_GENERATION_INFO of ADCControl_inst_1 : entity is "ADCControl_inst_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ADCControl_inst_1,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/vivado/PL-Mag-Sensor/PL-Mag-Sensor.srcs/sources_1/bd/ADCControl/ADCControl.bd,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of ADCControl_inst_1 : entity is "ADCControl_inst_1.hwdef";
end ADCControl_inst_1;

architecture STRUCTURE of ADCControl_inst_1 is
  component ADCControl_inst_1_SampleTimeLUT_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 5 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 19 downto 0 )
  );
  end component ADCControl_inst_1_SampleTimeLUT_0;
  component ADCControl_inst_1_ADC_controller_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    spi_cs : out STD_LOGIC;
  ...
  end component ADCControl_inst_1_ADC_controller_0;
  component ADCControl_inst_1_max_gain_0_0 is
  port (
    gains : in STD_LOGIC_VECTOR ( 23 downto 0 );
    max_gain_out : out STD_LOGIC_VECTOR ( 5 downto 0 )
  );
  end component ADCControl_inst_1_max_gain_0_0;
  component ADCControl_inst_1_sample_time_counter_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  end component ADCControl_inst_1_sample_time_counter_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN GainControl_test2_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
...
ADC_controller: component ADCControl_inst_1_ADC_controller_0
     port map (
      ch_out(3 downto 0) => ADC_controller_0_ch_out(3 downto 0),
      clk => clk_0_1,
      data_out(11 downto 0) => ADC_controller_0_data_out(11 downto 0),
