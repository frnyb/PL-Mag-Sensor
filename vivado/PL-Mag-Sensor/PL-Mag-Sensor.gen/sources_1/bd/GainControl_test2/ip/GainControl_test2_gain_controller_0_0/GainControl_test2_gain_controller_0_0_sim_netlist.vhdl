...
-- Date        : Fri Feb  4 15:20:05 2022
-- Host        : adm-59955 running 64-bit Ubuntu 20.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/vivado/PL-Mag-Sensor/PL-Mag-Sensor.gen/sources_1/bd/GainControl_test2/ip/GainControl_test2_gain_controller_0_0/GainControl_test2_gain_controller_0_0_sim_netlist.vhdl
-- Design      : GainControl_test2_gain_controller_0_0
...
entity GainControl_test2_gain_controller_0_0_gain_controller is
  port (
  ...
  attribute ORIG_REF_NAME of GainControl_test2_gain_controller_0_0_gain_controller : entity is "gain_controller";
end GainControl_test2_gain_controller_0_0_gain_controller;

architecture STRUCTURE of GainControl_test2_gain_controller_0_0_gain_controller is
  ...
  attribute SOFT_HLUTNM of adc_UnD_ref_int_i_2 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of adc_UnD_ref_int_i_4 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of adc_UnD_ref_int_i_8 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of adc_UnD_ref_int_i_9 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \gain_int[0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \gain_int[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \gain_int[4]_i_1\ : label is "soft_lutpair5";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity GainControl_test2_gain_controller_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    adc_UnD : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of GainControl_test2_gain_controller_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of GainControl_test2_gain_controller_0_0 : entity is "GainControl_test2_gain_controller_0_0,gain_controller,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of GainControl_test2_gain_controller_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of GainControl_test2_gain_controller_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of GainControl_test2_gain_controller_0_0 : entity is "gain_controller,Vivado 2020.2";
end GainControl_test2_gain_controller_0_0;

architecture STRUCTURE of GainControl_test2_gain_controller_0_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN GainControl_test2_clk_0, INSERT_VIP 0";
  attribute x_interface_info of rst_n : signal is "xilinx.com:signal:reset:1.0 rst_n RST";
  attribute x_interface_parameter of rst_n : signal is "XIL_INTERFACENAME rst_n, POLARITY ACTIVE_LOW, INSERT_VIP 0";
begin
U0: entity work.GainControl_test2_gain_controller_0_0_gain_controller
     port map (
      adc_UnD => adc_UnD,
      adc_UnD_ref => adc_UnD_ref,
      adc_nCS => adc_nCS,
