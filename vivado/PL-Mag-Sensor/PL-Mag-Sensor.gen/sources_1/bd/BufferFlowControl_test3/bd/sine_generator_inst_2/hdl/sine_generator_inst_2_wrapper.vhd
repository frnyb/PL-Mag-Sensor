...
--Command     : generate_target sine_generator_inst_2_wrapper.bd
--Design      : sine_generator_inst_2_wrapper
...
entity sine_generator_inst_2_wrapper is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
...
end sine_generator_inst_2_wrapper;

architecture STRUCTURE of sine_generator_inst_2_wrapper is
...
begin
sine_generator_inst_2_i: component sine_generator_inst_2
     port map (
      clk => clk,
      rst_n => rst_n,
