...
--Date        : Tue Feb 15 12:41:36 2022
--Host        : adm-59955 running 64-bit Ubuntu 20.04.3 LTS
--Command     : generate_target sine_generator_inst_2.bd
--Design      : sine_generator_inst_2
...
entity sine_generator_inst_2 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of sine_generator_inst_2 : entity is "sine_generator_inst_2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=sine_generator_inst_2,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=17,numReposBlks=17,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=/vol/Workspace/Projects/PL-Mag-Sensor/vivado/PL-Mag-Sensor/PL-Mag-Sensor.srcs/sources_1/bd/sine_generator/sine_generator.bd,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of sine_generator_inst_2 : entity is "sine_generator_inst_2.hwdef";
end sine_generator_inst_2;

architecture STRUCTURE of sine_generator_inst_2 is
  component sine_generator_inst_2_sine_100_0_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_100_0_0;
  component sine_generator_inst_2_sine_100_pi_3_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_100_pi_3_0;
  component sine_generator_inst_2_sine_100_2_pi_3_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_100_2_pi_3_0;
  component sine_generator_inst_2_sine_200_0_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_200_0_0;
  component sine_generator_inst_2_sine_200_2_pi_3_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_200_2_pi_3_0;
  component sine_generator_inst_2_sine_200_pi_3_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_200_pi_3_0;
  component sine_generator_inst_2_sine_300_0_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_300_0_0;
  component sine_generator_inst_2_sine_300_2_pi_3_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_300_2_pi_3_0;
  component sine_generator_inst_2_sine_300_pi_3_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_300_pi_3_0;
  component sine_generator_inst_2_sine_400_0_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_400_0_0;
  component sine_generator_inst_2_sine_400_2_pi_3_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_400_2_pi_3_0;
  component sine_generator_inst_2_sine_400_pi_3_0 is
  port (
    clka : in STD_LOGIC;
    addra : in STD_LOGIC_VECTOR ( 12 downto 0 );
    douta : out STD_LOGIC_VECTOR ( 11 downto 0 )
  );
  end component sine_generator_inst_2_sine_400_pi_3_0;
  component sine_generator_inst_2_counter_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  end component sine_generator_inst_2_counter_0_0;
  component sine_generator_inst_2_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 20 downto 0 )
  );
  end component sine_generator_inst_2_xlconstant_0_0;
  component sine_generator_inst_2_xlconstant_1_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component sine_generator_inst_2_xlconstant_1_0;
  component sine_generator_inst_2_xlconstant_2_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component sine_generator_inst_2_xlconstant_2_0;
  component sine_generator_inst_2_xlslice_0_0 is
  port (
    Din : in STD_LOGIC_VECTOR ( 20 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 12 downto 0 )
  );
  end component sine_generator_inst_2_xlslice_0_0;
...
counter_0: component sine_generator_inst_2_counter_0_0
     port map (
      clk => clk_0_1,
...
sine_100_0_RnM: component sine_generator_inst_2_sine_100_0_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_100_0_douta(11 downto 0)
    );
sine_100_2_pi_3_RnM: component sine_generator_inst_2_sine_100_2_pi_3_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_100_2_pi_3_douta(11 downto 0)
    );
sine_100_pi_3_RnM: component sine_generator_inst_2_sine_100_pi_3_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_100_pi_3_douta(11 downto 0)
    );
sine_200_0_RnM: component sine_generator_inst_2_sine_200_0_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_200_0_douta(11 downto 0)
    );
sine_200_2_pi_3_RnM: component sine_generator_inst_2_sine_200_2_pi_3_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_200_2_pi_3_douta(11 downto 0)
    );
sine_200_pi_3_RnM: component sine_generator_inst_2_sine_200_pi_3_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_200_pi_3_douta(11 downto 0)
    );
sine_300_0_RnM: component sine_generator_inst_2_sine_300_0_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_300_0_douta(11 downto 0)
    );
sine_300_2_pi_3_RnM: component sine_generator_inst_2_sine_300_2_pi_3_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_300_2_pi_3_douta(11 downto 0)
    );
sine_300_pi_3_RnM: component sine_generator_inst_2_sine_300_pi_3_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_300_pi_3_douta(11 downto 0)
    );
sine_400_0_RnM: component sine_generator_inst_2_sine_400_0_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_400_0_douta(11 downto 0)
    );
sine_400_2_pi_3_RnM: component sine_generator_inst_2_sine_400_2_pi_3_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_400_2_pi_3_douta(11 downto 0)
    );
sine_400_pi_3_RnM: component sine_generator_inst_2_sine_400_pi_3_0
     port map (
      addra(12 downto 0) => counter_0_cnt(12 downto 0),
      clka => clk_0_1,
      douta(11 downto 0) => sine_400_pi_3_douta(11 downto 0)
    );
xlconstant_0: component sine_generator_inst_2_xlconstant_0_0
     port map (
      dout(20 downto 0) => xlconstant_0_dout(20 downto 0)
    );
xlconstant_1: component sine_generator_inst_2_xlconstant_1_0
     port map (
      dout(0) => xlconstant_1_dout(0)
    );
xlconstant_2: component sine_generator_inst_2_xlconstant_2_0
     port map (
      dout(0) => xlconstant_2_dout(0)
    );
xlslice_0: component sine_generator_inst_2_xlslice_0_0
     port map (
