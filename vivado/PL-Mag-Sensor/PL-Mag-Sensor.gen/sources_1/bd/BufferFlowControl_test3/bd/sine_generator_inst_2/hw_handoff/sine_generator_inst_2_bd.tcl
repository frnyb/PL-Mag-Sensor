...
################################################################
# This is a generated script based on design: sine_generator_inst_2
#
...
# source sine_generator_inst_2_script.tcl
...
set design_name sine_generator_inst_2
...
if { ${design_name} eq "" } {
   ...
   create_bd_design -bdsource /vol/Workspace/Projects/PL-Mag-Sensor/vivado/PL-Mag-Sensor/PL-Mag-Sensor.srcs/sources_1/bd/sine_generator/sine_generator.bd $design_name
