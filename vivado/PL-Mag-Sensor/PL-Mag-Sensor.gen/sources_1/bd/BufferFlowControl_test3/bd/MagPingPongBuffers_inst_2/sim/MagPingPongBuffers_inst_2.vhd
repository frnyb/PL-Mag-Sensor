...
--Date        : Tue Feb 15 09:01:33 2022
--Host        : ffn-X299 running 64-bit Ubuntu 20.04.3 LTS
--Command     : generate_target MagPingPongBuffers_inst_2.bd
--Design      : MagPingPongBuffers_inst_2
...
entity MagPingPongBuffers_inst_2 is
  port (
  ...
  attribute CORE_GENERATION_INFO of MagPingPongBuffers_inst_2 : entity is "MagPingPongBuffers_inst_2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=MagPingPongBuffers_inst_2,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=19,numReposBlks=19,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=16,numPkgbdBlks=0,bdsource=/vol/Workspace/Projects/PL-Mag-Sensor/vivado/PL-Mag-Sensor/PL-Mag-Sensor.srcs/sources_1/bd/MagPingPongBuffers/MagPingPongBuffers.bd,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of MagPingPongBuffers_inst_2 : entity is "MagPingPongBuffers_inst_2.hwdef";
end MagPingPongBuffers_inst_2;

architecture STRUCTURE of MagPingPongBuffers_inst_2 is
  component MagPingPongBuffers_inst_2_hold_slice_0 is
  port (
  ...
  end component MagPingPongBuffers_inst_2_hold_slice_0;
  component MagPingPongBuffers_inst_2_shift_slice_0 is
  port (
    inp : in STD_LOGIC_VECTOR ( 11 downto 0 );
    ch0 : out STD_LOGIC;
    ch1 : out STD_LOGIC;
  ...
  end component MagPingPongBuffers_inst_2_shift_slice_0;
  component MagPingPongBuffers_inst_2_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 7 downto 0 )
  );
  end component MagPingPongBuffers_inst_2_xlconstant_0_0;
  component MagPingPongBuffers_inst_2_busy_concat_0 is
  port (
  ...
  end component MagPingPongBuffers_inst_2_busy_concat_0;
  component MagPingPongBuffers_inst_2_irq_concat_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In2 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component MagPingPongBuffers_inst_2_irq_concat_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_0_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_10_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_10_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_11_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_11_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_1_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_1_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_2_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_2_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_3_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_3_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_4_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_4_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_5_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_5_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_6_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_6_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_7_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_7_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_8_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_8_0;
  component MagPingPongBuffers_inst_2_mag_pingpong_buffer_9_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 9 downto 0 );
  ...
  end component MagPingPongBuffers_inst_2_mag_pingpong_buffer_9_0;
  component MagPingPongBuffers_inst_2_wr_slice_0 is
  port (
    inp : in STD_LOGIC_VECTOR ( 11 downto 0 );
    ch0 : out STD_LOGIC;
    ch1 : out STD_LOGIC;
  ...
  end component MagPingPongBuffers_inst_2_wr_slice_0;
  component MagPingPongBuffers_inst_2_rd_mux_0 is
  port (
  ...
  end component MagPingPongBuffers_inst_2_rd_mux_0;
...
busy_concat: component MagPingPongBuffers_inst_2_busy_concat_0
     port map (
...
hold_slice: component MagPingPongBuffers_inst_2_hold_slice_0
     port map (
      ch0 => hold_slice_ch0,
      ch1 => hold_slice_ch1,
...
irq_concat: component MagPingPongBuffers_inst_2_irq_concat_0
     port map (
...
mag_pingpong_buffer_0: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_0_0
     port map (
...
mag_pingpong_buffer_1: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_1_0
     port map (
...
mag_pingpong_buffer_10: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_10_0
     port map (
...
mag_pingpong_buffer_11: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_11_0
     port map (
...
mag_pingpong_buffer_2: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_2_0
     port map (
...
mag_pingpong_buffer_3: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_3_0
     port map (
...
mag_pingpong_buffer_4: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_4_0
     port map (
...
mag_pingpong_buffer_5: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_5_0
     port map (
...
mag_pingpong_buffer_6: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_6_0
     port map (
...
mag_pingpong_buffer_7: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_7_0
     port map (
...
mag_pingpong_buffer_8: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_8_0
     port map (
...
mag_pingpong_buffer_9: component MagPingPongBuffers_inst_2_mag_pingpong_buffer_9_0
     port map (
...
rd_mux: component MagPingPongBuffers_inst_2_rd_mux_0
     port map (
...
shift_slice: component MagPingPongBuffers_inst_2_shift_slice_0
     port map (
      ch0 => shift_slice_ch0,
      ch1 => shift_slice_ch1,
...
wr_slice: component MagPingPongBuffers_inst_2_wr_slice_0
     port map (
      ch0 => wr_slice_ch0,
      ch1 => wr_slice_ch1,
      ch10 => wr_slice_ch10,
...
xlconstant_0: component MagPingPongBuffers_inst_2_xlconstant_0_0
     port map (
