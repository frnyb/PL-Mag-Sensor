...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net mag0_scl_i_0_1 [get_bd_ports mag0_scl_i] [get_bd_pins DigMagController_0/mag0_scl_i]
  connect_bd_net -net mag0_sda_i_0_1 [get_bd_ports mag0_sda_i] [get_bd_pins DigMagController_0/mag0_sda_i]
  connect_bd_net -net mag1_scl_i_0_1 [get_bd_ports mag1_scl_i] [get_bd_pins DigMagController_0/mag1_scl_i]
  connect_bd_net -net mag1_sda_i_0_1 [get_bd_ports mag1_sda_i] [get_bd_pins DigMagController_0/mag1_sda_i]
  connect_bd_net -net mag2_scl_i_0_1 [get_bd_ports mag2_scl_i] [get_bd_pins DigMagController_0/mag2_scl_i]
  connect_bd_net -net mag2_sda_i_0_1 [get_bd_ports mag2_sda_i] [get_bd_pins DigMagController_0/mag2_sda_i]
  connect_bd_net -net mag3_scl_i_0_1 [get_bd_ports mag3_scl_i] [get_bd_pins DigMagController_0/mag3_scl_i]
  connect_bd_net -net mag3_sda_i_0_1 [get_bd_ports mag3_sda_i] [get_bd_pins DigMagController_0/mag3_sda_i]
