...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net DigMagController_0_ch_out [get_bd_ports ch_out] [get_bd_pins BufferFlowControl_0/adc_ch]
  connect_bd_net -net DigMagController_0_dout [get_bd_ports data_out] [get_bd_pins BufferFlowControl_0/adc_din]
  connect_bd_net -net DigMagController_0_irq_out [get_bd_ports irq_out] [get_bd_pins BufferFlowControl_0/adc_irq]
