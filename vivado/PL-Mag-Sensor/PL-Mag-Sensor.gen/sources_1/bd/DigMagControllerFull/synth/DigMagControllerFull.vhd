...
architecture STRUCTURE of DigMagControllerFull is
  ...
  component DigMagControllerFull_DigMagController_0_0 is
  port (
    ch_out : out STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
  ...
  end component DigMagControllerFull_DigMagController_0_0;
  ...
  signal mag0_scl_i_0_1 : STD_LOGIC;
  signal mag0_sda_i_0_1 : STD_LOGIC;
  signal mag1_scl_i_0_1 : STD_LOGIC;
  signal mag1_sda_i_0_1 : STD_LOGIC;
  signal mag2_scl_i_0_1 : STD_LOGIC;
  signal mag2_sda_i_0_1 : STD_LOGIC;
  signal mag3_scl_i_0_1 : STD_LOGIC;
  signal mag3_sda_i_0_1 : STD_LOGIC;
...
DigMagController_0: component DigMagControllerFull_DigMagController_0_0
     port map (
      ch_out(3 downto 0) => DigMagController_0_ch_out(3 downto 0),
      clk => clk_1,
      dout(11 downto 0) => DigMagController_0_dout(11 downto 0),
      irq_out => DigMagController_0_irq_out,
      mag0_scl_i => mag0_scl_i_0_1,
      mag0_scl_o => DigMagController_0_mag0_scl_o,
      mag0_scl_t => DigMagController_0_mag0_scl_t,
      mag0_sda_i => mag0_sda_i_0_1,
      mag0_sda_o => DigMagController_0_mag0_sda_o,
      mag0_sda_t => DigMagController_0_mag0_sda_t,
      mag1_scl_i => mag1_scl_i_0_1,
      mag1_scl_o => DigMagController_0_mag1_scl_o,
      mag1_scl_t => DigMagController_0_mag1_scl_t,
      mag1_sda_i => mag1_sda_i_0_1,
      mag1_sda_o => DigMagController_0_mag1_sda_o,
      mag1_sda_t => DigMagController_0_mag1_sda_t,
      mag2_scl_i => mag2_scl_i_0_1,
      mag2_scl_o => DigMagController_0_mag2_scl_o,
      mag2_scl_t => DigMagController_0_mag2_scl_t,
      mag2_sda_i => mag2_sda_i_0_1,
      mag2_sda_o => DigMagController_0_mag2_sda_o,
      mag2_sda_t => DigMagController_0_mag2_sda_t,
      mag3_scl_i => mag3_scl_i_0_1,
      mag3_scl_o => DigMagController_0_mag3_scl_o,
      mag3_scl_t => DigMagController_0_mag3_scl_t,
      mag3_sda_i => mag3_sda_i_0_1,
      mag3_sda_o => DigMagController_0_mag3_sda_o,
      mag3_sda_t => DigMagController_0_mag3_sda_t,
      rst_n => rst_n_1
    );
