...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "t_period_target_val" -parent ${Page_0}
  ipgui::add_param $IPINST -name "t_sample_n_bits" -parent ${Page_0}
  ipgui::add_param $IPINST -name "t_sample_target_val" -parent ${Page_0}
...
proc update_PARAM_VALUE.t_period_target_val { PARAM_VALUE.t_period_target_val } {
	# Procedure called to update t_period_target_val when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.t_period_target_val { PARAM_VALUE.t_period_target_val } {
	# Procedure called to validate t_period_target_val
	return true
}
...
proc update_PARAM_VALUE.t_sample_target_val { PARAM_VALUE.t_sample_target_val } {
	# Procedure called to update t_sample_target_val when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.t_sample_target_val { PARAM_VALUE.t_sample_target_val } {
	# Procedure called to validate t_sample_target_val
	return true
}
...
proc update_MODELPARAM_VALUE.t_sample_target_val { MODELPARAM_VALUE.t_sample_target_val PARAM_VALUE.t_sample_target_val } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.t_sample_target_val}] ${MODELPARAM_VALUE.t_sample_target_val}
}
...
proc update_MODELPARAM_VALUE.t_period_target_val { MODELPARAM_VALUE.t_period_target_val PARAM_VALUE.t_period_target_val } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.t_period_target_val}] ${MODELPARAM_VALUE.t_period_target_val}
}
