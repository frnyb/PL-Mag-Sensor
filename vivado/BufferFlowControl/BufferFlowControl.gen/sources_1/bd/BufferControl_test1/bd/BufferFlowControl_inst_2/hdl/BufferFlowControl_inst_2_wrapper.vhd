...
--Command     : generate_target BufferFlowControl_inst_2_wrapper.bd
--Design      : BufferFlowControl_inst_2_wrapper
...
entity BufferFlowControl_inst_2_wrapper is
  port (
...
end BufferFlowControl_inst_2_wrapper;

architecture STRUCTURE of BufferFlowControl_inst_2_wrapper is
  component BufferFlowControl_inst_2 is
  port (
    adc_ch : in STD_LOGIC_VECTOR ( 3 downto 0 );
    adc_din : in STD_LOGIC_VECTOR ( 11 downto 0 );
    adc_irq : in STD_LOGIC;
  ...
  end component BufferFlowControl_inst_2;
begin
BufferFlowControl_inst_2_i: component BufferFlowControl_inst_2
     port map (
