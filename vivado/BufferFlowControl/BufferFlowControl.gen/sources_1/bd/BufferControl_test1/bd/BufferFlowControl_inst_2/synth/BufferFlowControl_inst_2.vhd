...
--Date        : Mon Mar 21 14:50:50 2022
--Host        : adm-59955 running 64-bit Ubuntu 20.04.3 LTS
--Command     : generate_target BufferFlowControl_inst_2.bd
--Design      : BufferFlowControl_inst_2
...
entity BufferFlowControl_imp_1DV09PB is
  port (
...
end BufferFlowControl_imp_1DV09PB;

architecture STRUCTURE of BufferFlowControl_imp_1DV09PB is
  component BufferFlowControl_inst_2_signal_period_counter_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  end component BufferFlowControl_inst_2_signal_period_counter_0;
  component BufferFlowControl_inst_2_sample_interval_counter_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  end component BufferFlowControl_inst_2_sample_interval_counter_0;
  component BufferFlowControl_inst_2_buffer_controller_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
  ...
  end component BufferFlowControl_inst_2_buffer_controller_0_0;
  component BufferFlowControl_inst_2_MagPingPongBuffers_0_0 is
  port (
  ...
  end component BufferFlowControl_inst_2_MagPingPongBuffers_0_0;
...
begin
  ...
  rst_n_0_1 <= rst_n;
MagPingPongBuffers_0: component BufferFlowControl_inst_2_MagPingPongBuffers_0_0
     port map (
...
buffer_controller_0: component BufferFlowControl_inst_2_buffer_controller_0_0
     port map (
...
sample_interval_counter: component BufferFlowControl_inst_2_sample_interval_counter_0
     port map (
      clk => clk_0_1,
...
signal_period_counter: component BufferFlowControl_inst_2_signal_period_counter_0
     port map (
      clk => clk_0_1,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BufferFlowControl_inst_2 is
  port (
    adc_ch : in STD_LOGIC_VECTOR ( 3 downto 0 );
    adc_din : in STD_LOGIC_VECTOR ( 11 downto 0 );
    adc_irq : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of BufferFlowControl_inst_2 : entity is "BufferFlowControl_inst_2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BufferFlowControl_inst_2,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=6,numReposBlks=5,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=1,bdsource=/home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/vivado/BufferFlowControl/BufferFlowControl.srcs/sources_1/bd/BufferFlowControl/BufferFlowControl.bd,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of BufferFlowControl_inst_2 : entity is "BufferFlowControl_inst_2.hwdef";
end BufferFlowControl_inst_2;

architecture STRUCTURE of BufferFlowControl_inst_2 is
  component BufferFlowControl_inst_2_or_gate_0_0 is
  port (
    inp : in STD_LOGIC_VECTOR ( 11 downto 0 );
    outp : out STD_LOGIC
  );
  end component BufferFlowControl_inst_2_or_gate_0_0;
...
begin
  ...
  rst_n_0_1 <= rst_n;
BufferFlowControl: entity work.BufferFlowControl_imp_1DV09PB
     port map (
      adc_ch(3 downto 0) => adc_ch_1(3 downto 0),
      adc_din(11 downto 0) => adc_din_1(11 downto 0),
      adc_irq => adc_irq_1,
...
or_gate_0: component BufferFlowControl_inst_2_or_gate_0_0
     port map (
