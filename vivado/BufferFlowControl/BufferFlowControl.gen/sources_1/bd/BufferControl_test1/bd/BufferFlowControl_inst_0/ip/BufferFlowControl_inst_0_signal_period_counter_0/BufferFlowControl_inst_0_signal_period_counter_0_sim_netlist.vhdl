...
--               /home/ffn/Nextcloud/Workspace/Projects/PL-Mag-Sensor/vivado/BufferFlowControl/BufferFlowControl.gen/sources_1/bd/BufferControl_test1/bd/BufferFlowControl_inst_0/ip/BufferFlowControl_inst_0_signal_period_counter_0/BufferFlowControl_inst_0_signal_period_counter_0_sim_netlist.vhdl
...
entity BufferFlowControl_inst_0_signal_period_counter_0_counter is
  port (
  ...
  attribute ORIG_REF_NAME of BufferFlowControl_inst_0_signal_period_counter_0_counter : entity is "counter";
end BufferFlowControl_inst_0_signal_period_counter_0_counter;

architecture STRUCTURE of BufferFlowControl_inst_0_signal_period_counter_0_counter is
  ...
  signal \cnt_int[20]_i_8_n_0\ : STD_LOGIC;
  ...
  signal \cnt_int_reg[20]_i_2_n_11\ : STD_LOGIC;
  signal \cnt_int_reg[20]_i_2_n_12\ : STD_LOGIC;
  signal \cnt_int_reg[20]_i_2_n_13\ : STD_LOGIC;
  signal \cnt_int_reg[20]_i_2_n_14\ : STD_LOGIC;
  signal \cnt_int_reg[20]_i_2_n_15\ : STD_LOGIC;
  signal \cnt_int_reg[20]_i_2_n_4\ : STD_LOGIC;
  signal \cnt_int_reg[20]_i_2_n_5\ : STD_LOGIC;
  signal \cnt_int_reg[20]_i_2_n_6\ : STD_LOGIC;
  ...
  signal \irq_int0_carry__0_i_5_n_0\ : STD_LOGIC;
  signal \irq_int0_carry__0_i_6_n_0\ : STD_LOGIC;
  signal \irq_int0_carry__0_n_6\ : STD_LOGIC;
  ...
  signal \NLW_cnt_int_reg[20]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 4 );
  signal \NLW_cnt_int_reg[20]_i_2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 5 );
  signal NLW_irq_int0_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \NLW_irq_int0_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 7 downto 3 );
  ...
  attribute ADDER_THRESHOLD of \cnt_int_reg[20]_i_2\ : label is 16;
...
\cnt_int[20]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\cnt_int[20]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\cnt_int[20]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\cnt_int[20]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\cnt_int[20]_i_7\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\cnt_int[20]_i_8\: unisim.vcomponents.LUT6
    generic map(
...
\cnt_int_reg[20]_i_2\: unisim.vcomponents.CARRY8
     port map (
      CI => \cnt_int_reg[15]_i_1_n_0\,
      CI_TOP => '0',
      CO(7 downto 4) => \NLW_cnt_int_reg[20]_i_2_CO_UNCONNECTED\(7 downto 4),
      CO(3) => \cnt_int_reg[20]_i_2_n_4\,
      CO(2) => \cnt_int_reg[20]_i_2_n_5\,
      CO(1) => \cnt_int_reg[20]_i_2_n_6\,
      CO(0) => \cnt_int_reg[20]_i_2_n_7\,
      DI(7 downto 0) => B"00000000",
      O(7 downto 5) => \NLW_cnt_int_reg[20]_i_2_O_UNCONNECTED\(7 downto 5),
      O(4) => \cnt_int_reg[20]_i_2_n_11\,
      O(3) => \cnt_int_reg[20]_i_2_n_12\,
      O(2) => \cnt_int_reg[20]_i_2_n_13\,
      O(1) => \cnt_int_reg[20]_i_2_n_14\,
      O(0) => \cnt_int_reg[20]_i_2_n_15\,
      S(7 downto 5) => B"000",
      S(4 downto 0) => \^cnt\(20 downto 16)
    );
...
\irq_int0_carry__0\: unisim.vcomponents.CARRY8
     port map (
      ...
      CI_TOP => '0',
      CO(7 downto 3) => \NLW_irq_int0_carry__0_CO_UNCONNECTED\(7 downto 3),
      CO(2) => irq,
      CO(1) => \irq_int0_carry__0_n_6\,
      CO(0) => \irq_int0_carry__0_n_7\,
      DI(7 downto 3) => B"00000",
      DI(2) => \irq_int0_carry__0_i_1_n_0\,
      DI(1) => \irq_int0_carry__0_i_2_n_0\,
      DI(0) => \irq_int0_carry__0_i_3_n_0\,
      O(7 downto 0) => \NLW_irq_int0_carry__0_O_UNCONNECTED\(7 downto 0),
      S(7 downto 3) => B"00000",
      S(2) => \irq_int0_carry__0_i_4_n_0\,
      S(1) => \irq_int0_carry__0_i_5_n_0\,
      S(0) => \irq_int0_carry__0_i_6_n_0\
    );
\irq_int0_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\irq_int0_carry__0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
\irq_int0_carry__0_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\irq_int0_carry__0_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BufferFlowControl_inst_0_signal_period_counter_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    en : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of BufferFlowControl_inst_0_signal_period_counter_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of BufferFlowControl_inst_0_signal_period_counter_0 : entity is "BufferFlowControl_inst_0_signal_period_counter_0,counter,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of BufferFlowControl_inst_0_signal_period_counter_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of BufferFlowControl_inst_0_signal_period_counter_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of BufferFlowControl_inst_0_signal_period_counter_0 : entity is "counter,Vivado 2020.2";
end BufferFlowControl_inst_0_signal_period_counter_0;

architecture STRUCTURE of BufferFlowControl_inst_0_signal_period_counter_0 is
...
begin
U0: entity work.BufferFlowControl_inst_0_signal_period_counter_0_counter
     port map (
      clk => clk,
      cnt(20 downto 0) => cnt(20 downto 0),
      en => en,
