...
architecture STRUCTURE of PingPongBuffer is
  component PingPongBuffer_pingpong_buffer_0_1 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    rd_addr : in STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  end component PingPongBuffer_pingpong_buffer_0_1;
  component PingPongBuffer_instant_ram_0_0 is
  port (
    rst_n : in STD_LOGIC;
  ...
  end component PingPongBuffer_instant_ram_0_0;
  component PingPongBuffer_instant_ram_0_1 is
  port (
    rst_n : in STD_LOGIC;
    din : in STD_LOGIC_VECTOR ( 31 downto 0 );
    dout : out STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component PingPongBuffer_instant_ram_0_1;
...
instant_ram_0: component PingPongBuffer_instant_ram_0_0
     port map (
...
instant_ram_1: component PingPongBuffer_instant_ram_0_1
     port map (
...
pingpong_buffer_0: component PingPongBuffer_pingpong_buffer_0_1
     port map (
      busy => pingpong_buffer_0_busy,
      clk => clk_0_1,
      hold => hold_1,
